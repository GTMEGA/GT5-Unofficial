...
public class GT_Cover_EUMeter extends GT_CoverBehavior {
    ...
    private class GUI extends GT_GUICover {
        ...
        public GUI(byte aSide, int aCoverID, int aCoverVariable, ICoverable aTileEntity) {
            ...
            IGuiElement b;
            b = new GT_GuiIconCheckButton(this, 0, startX, startY + spaceY, GT_GuiIcon.CHECKMARK, null).setTooltipText(
                    trans("256", "Universal Storage"));
            b = new GT_GuiIconCheckButton(this, 1, startX, startY, GT_GuiIcon.CHECKMARK, null).setTooltipText(
                    trans("257", "Electricity Storage"));
            b = new GT_GuiIconCheckButton(this, 2, startX, startY + spaceY * 2, GT_GuiIcon.CHECKMARK, null).setTooltipText(
                    trans("258", "Steam Storage"));
            b = new GT_GuiIconCheckButton(this, 3, startX + spaceX * 4, startY + spaceY, GT_GuiIcon.CHECKMARK, null).setTooltipText(
                    trans("259", "Average Electric Input"));
            b = new GT_GuiIconCheckButton(this, 4, startX + spaceX * 4, startY + spaceY * 2, GT_GuiIcon.CHECKMARK, null).setTooltipText(
                    trans("260", "Average Electric Output"));
            b = new GT_GuiIconCheckButton(this, 5, startX + spaceX * 4, startY, GT_GuiIcon.CHECKMARK, null).setTooltipText(
                    trans("261", "Electricity Storage(Including Batteries)"));
            b = new GT_GuiIconCheckButton(this, 6, startX, startY + spaceY * 3, GT_GuiIcon.CHECKMARK, null).setTooltipText(
                    trans("262", "Electricity Storage(Only Batteries)"));
        ...
        public void drawExtras(int mouseX, int mouseY, float parTicks) {
            ...
            this.fontRendererObj.drawString("Universal", startX + spaceX, 4 + startY + spaceY, 0xFF555555);
            this.fontRendererObj.drawString("Int. EU", startX + spaceX, 4 + startY, 0xFF555555);
            this.fontRendererObj.drawString("Steam", startX + spaceX, 4 + startY + spaceY * 2, 0xFF555555);
            this.fontRendererObj.drawString("Avg. Input", startX + spaceX * 5, 4 + startY + spaceY, 0xFF555555);
            this.fontRendererObj.drawString("Avg. Output", startX + spaceX * 5, 4 + startY + spaceY * 2, 0xFF555555);
            this.fontRendererObj.drawString("EU stored", startX + spaceX * 5, 4 + startY, 0xFF555555);
            this.fontRendererObj.drawString("Bat stored", startX + spaceX, 4 + startY + spaceY * 3, 0xFF555555);
        }
    ...
    public int onCoverScrewdriverclick(
        ...
        switch (aCoverVariable) {
            ...
            case 11:
                ...
                break;
            case 12:
                GT_Utility.sendChatToPlayer(aPlayer, trans("043", "Normal Electricity Storage(Only Batteries)"));
                break;
            case 13:
                GT_Utility.sendChatToPlayer(aPlayer, trans("044", "Inverted Electricity Storage(Only Batteries)"));
                break;
        }
        ...
        if (aCoverVariable < 2) {
            ...
            if (tScale > 0L) {
                aTileEntity.setOutputRedstoneSignal(
                        aSide, aCoverVariable % 2 == 0 ? (byte) (int) (aTileEntity.getUniversalEnergyStored() / tScale)
            ...
            if (tScale > 0L) {
                aTileEntity.setOutputRedstoneSignal(
                        aSide, aCoverVariable % 2 == 0 ? (byte) (int) (aTileEntity.getStoredEU() / tScale)
            ...
            if (tScale > 0L) {
                aTileEntity.setOutputRedstoneSignal(
                        aSide, aCoverVariable % 2 == 0 ? (byte) (int) (aTileEntity.getStoredSteam() / tScale)
            ...
            if (tScale > 0L) {
                aTileEntity.setOutputRedstoneSignal(
                        aSide, aCoverVariable % 2 == 0 ? (byte) (int) (aTileEntity.getAverageElectricInput() / tScale)
            ...
            if (tScale > 0L) {
                aTileEntity.setOutputRedstoneSignal(
                        aSide, aCoverVariable % 2 == 0 ? (byte) (int) (aTileEntity.getAverageElectricOutput() / tScale)
