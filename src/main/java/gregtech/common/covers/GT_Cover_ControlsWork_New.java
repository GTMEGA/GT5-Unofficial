...
public class GT_Cover_ControlsWork_New extends GT_CoverBehaviorBase<GT_Cover_ControlsWork_New.InternalData> {
    ...
    public GT_Cover_ControlsWork_New() {
    ...
    protected Object getClientGUIImpl(byte aSide, int aCoverID, InternalData aCoverVariable, ICoverable aTileEntity, EntityPlayer aPlayer, World aWorld) {
        return new GT_Cover_ControlsWork_New.GUI(aSide, aCoverID, aCoverVariable, aTileEntity);
    }
