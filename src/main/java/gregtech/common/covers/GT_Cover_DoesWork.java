...
public class GT_Cover_DoesWork extends GT_CoverBehavior {
    ...
    private class GUI extends GT_GUICover {
        ...
        public GUI(byte aSide, int aCoverID, int aCoverVariable, ICoverable aTileEntity) {
            ...
            GuiButton b;
            b = new GT_GuiIconButton(this, 0, startX, startY, GT_GuiIcon.PROGRESS);
            b = new GT_GuiIconButton(this, 1, startX + spaceX, startY, GT_GuiIcon.CHECKMARK);
            b = new GT_GuiIconCheckButton(this, 2, startX, startY + spaceY, GT_GuiIcon.REDSTONE_ON, GT_GuiIcon.REDSTONE_OFF);
        }
            ...
            if (aCoverVariable < 2) {
                ...
                if ((tScale > 0) && (((IMachineProgress) aTileEntity).hasThingsToDo())) {
                    aTileEntity.setOutputRedstoneSignal(
                            aSide, aCoverVariable % 2 == 0 ? (byte) (((IMachineProgress) aTileEntity).getProgress() / tScale)
                ...
                aTileEntity.setOutputRedstoneSignal(
                        aSide, (byte) (
                                (aCoverVariable % 2 == 0 ? 1 : 0) != (((IMachineProgress) aTileEntity).getMaxProgress() == 0 ? 1 : 0) ? 0 : 15
                        ));
            }
        } else {
