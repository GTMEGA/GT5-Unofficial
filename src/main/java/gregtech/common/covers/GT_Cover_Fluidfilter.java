...
public class GT_Cover_Fluidfilter extends GT_CoverBehaviorBase<GT_Cover_Fluidfilter.FluidFilterData> {
    ...
    private class GT_FluidFilterGUICover extends GT_GUICover {
        ...
        public GT_FluidFilterGUICover(byte aSide, int aCoverID, FluidFilterData aCoverVariable, ICoverable aTileEntity) {
            ...
            IGuiElement b;
            b = new GT_GuiIconButton(this, 0, startX, startY, GT_GuiIcon.IMPORT).setTooltipText(trans("232", "Filter Input"));
            b = new GT_GuiIconButton(this, 1, startX + spaceX, startY, GT_GuiIcon.EXPORT).setTooltipText(trans("233", "Filter Output"));
            b = new GT_GuiIconButton(this, 2, startX, startY + spaceY * 2, GT_GuiIcon.BLOCK_INPUT).setTooltipText(trans("234", "Block Output"));
            b = new GT_GuiIconButton(this, 3, startX + spaceX, startY + spaceY * 2, GT_GuiIcon.ALLOW_INPUT).setTooltipText(trans("235", "Allow Output"));
            b = new GT_GuiIconButton(this, 4, startX, startY + spaceY, GT_GuiIcon.WHITELIST).setTooltipText(trans("236", "Whitelist Fluid"));
            b = new GT_GuiIconButton(this, 5, startX + spaceX, startY + spaceY, GT_GuiIcon.BLACKLIST).setTooltipText(trans("237", "Blacklist Fluid"));
    ...
    protected boolean onCoverRightClickImpl(
        ...
        if (((aX > 0.375D) && (aX < 0.625D)) || ((aSide > 3) && ((aY > 0.375D) && (aY < 0.625D))) || ((aSide < 2) && ((aZ > 0.375D) && (aZ < 0.625D))) ||
            (aSide == 2) || (aSide == 3)) {
