...
public abstract class GT_Cover_RedstoneWirelessBase extends GT_CoverBehavior {
    ...
    private class GUI extends GT_GUICover {
        ...
        public GUI(byte aSide, int aCoverID, int aCoverVariable, ICoverable aTileEntity) {
            ...
            fBox = new GT_GuiShortTextBox(this, 2, startX, startY + 2, spaceX * 4 - 3, 12);
            fBox.setText(String.valueOf(coverVariable & PUBLIC_MASK));
            fBox.setMaxStringLength(12);

            GuiButton b;
            b = new GT_GuiIconCheckButton(this, 0, startX, startY + spaceY * 2, GT_GuiIcon.CHECKMARK, null);
        }
        ...
        public void drawExtras(int mouseX, int mouseY, float parTicks) {
            ...
            this.getFontRenderer().drawString(trans("601", "Use Private Frequency"), startX + spaceX, startY + spaceY * 2 + 4, 0xFF555555);
        }
    ...
    protected boolean onCoverRightClickImpl(
        ...
        if (((aX > 0.375D) && (aX < 0.625D)) || ((aSide > 3) && ((aY > 0.375D) && (aY < 0.625D)))) {
            ...
            aCoverVariable.set((aCoverVariable.get() & (PRIVATE_MASK | CHECKBOX_MASK)) | (
                    (
                            (Integer) GT_Utility.stackToInt(aPlayer.inventory.getCurrentItem())
                    ).hashCode() & PUBLIC_MASK
            ));
