...
public class GT_Cover_Arm extends GT_CoverBehavior {
    ...
    private class GUI extends GT_GUICover {
        ...
        private final GT_GuiIntegerTextBox adjSlot;
        ...
        public GUI(byte aSide, int aCoverID, int aCoverVariable, ICoverable aTileEntity) {
            ...
            adjSlot = new GT_GuiIntegerTextBox(this, 3, startX, startY + spaceY * 2 + 2, spaceX * 2 + 5, 12);
        ...
        if (fromSlot > 0 && toSlot > 0) {
            if (fromTile instanceof IInventory && toTile instanceof IInventory) {
                movedItems = GT_Utility.moveFromSlotToSlot(
                        (IInventory) fromTile, (IInventory) toTile, fromSlot - 1, toSlot - 1, null, false, (byte) 64, (byte) 1, (byte) 64, (byte) 1);
            }
        } else if (toSlot > 0) {
            byte side;
            if ((aCoverVariable & EXPORT_MASK) > 0) {
            ...
            if (fromTile instanceof IInventory) {
                movedItems = GT_Utility.moveFromSlotToSide(
                        (IInventory) fromTile, toTile, fromSlot - 1, toSide, null, false, (byte) 64, (byte) 1, (byte) 64, (byte) 1);
            }
        } else {
