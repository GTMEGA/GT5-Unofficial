...
public class GT_Cover_NeedMaintainance extends GT_CoverBehavior {
    ...
    private class GUI extends GT_GUICover {
        ...
        private final String[] tooltiptext = {
                trans("056", "Emit if 1 Maintenance Needed"), trans("058", "Emit if 2 Maintenance Needed"), trans("060", "Emit if 3 Maintenance Needed"), trans(
                "062", "Emit if 4 Maintenance Needed"), trans("064", "Emit if 5 Maintenance Needed"), trans(
                "066", "Emit if rotor needs maintenance low accuracy mod"), trans(
                "068", "Emit if rotor needs maintenance high accuracy mod"),
                };

        private final String[] buttontext = {
                trans("247", "1 Issue"), trans("248", "2 Issues"), trans("249", "3 Issues"), trans("250", "4 Issues"), trans("251", "5 Issues"), trans(
                "252", "Rotor < 80%"), trans("253", "Rotor < 100%"),

                trans("INVERTED", "Inverted"), trans("NORMAL", "Normal"),
                };
        ...
        public GUI(byte aSide, int aCoverID, int aCoverVariable, ICoverable aTileEntity) {
            ...
            IGuiElement b;
            b = new GT_GuiIconCheckButton(this, 0, startX, startY, GT_GuiIcon.CHECKMARK, null).setTooltipText(tooltiptext[0]);
            b = new GT_GuiIconCheckButton(this, 1, startX, startY + spaceY, GT_GuiIcon.CHECKMARK, null).setTooltipText(tooltiptext[1]);
            b = new GT_GuiIconCheckButton(this, 2, startX, startY + spaceY * 2, GT_GuiIcon.CHECKMARK, null).setTooltipText(tooltiptext[2]);
            b = new GT_GuiIconCheckButton(this, 3, startX, startY + spaceY * 3, GT_GuiIcon.CHECKMARK, null).setTooltipText(tooltiptext[3]);
            b = new GT_GuiIconCheckButton(this, 4, startX + spaceX * 4 + 4, startY, GT_GuiIcon.CHECKMARK, null).setTooltipText(tooltiptext[4]);
            b = new GT_GuiIconCheckButton(this, 5, startX + spaceX * 4 + 4, startY + spaceY, GT_GuiIcon.CHECKMARK, null).setTooltipText(tooltiptext[5]);
