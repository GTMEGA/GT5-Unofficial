...
public class GT_MetaTileEntity_Boiler_Semi extends GT_MetaTileEntity_Boiler {
    ...
    public GT_MetaTileEntity_Boiler_Semi(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional, new String[]{
                "Burns creosote and oil at " + EFFICIENCY * 100 + "% efficiency", "Produces " + PRODUCTION_PER_SECOND + "L of Steam per second",
    ...
    public ITexture[][][] getTextureSet(ITexture[] aTextures) {
        ...
        final ITexture[] texBottom = {TextureFactory.of(MACHINE_STEELBRICKS_BOTTOM)}, texTop = {
                ...
                TextureFactory.of(MACHINE_STEELBRICKS_SIDE), TextureFactory.of(BOILER_LAVA_FRONT), TextureFactory.of(BOILER_LAVA_FRONT_GLOW)
        }, texFrontActive = {
                TextureFactory.of(MACHINE_STEELBRICKS_SIDE), TextureFactory.of(BOILER_LAVA_FRONT_ACTIVE), TextureFactory.builder().addIcon(
                BOILER_LAVA_FRONT_ACTIVE_GLOW).glow().build()
        };
        for (byte i = 0; i < 17; i++) {
