...
public class GT_Item_DaisyCutter extends GT_Item_Explosive {
    ...
    public void addInformation(final ItemStack stack, final EntityPlayer player, final List lore, final boolean b0) {
        final String[] lines = {
                "The Daisy Cutter", "An explosive, developed by a bygone civilization, which blows away only foliage",
                "to make room for industrial progress. Destroys most items.", "Prime with a Remote Detonator", "Packs a pretty mean punch, so take",
