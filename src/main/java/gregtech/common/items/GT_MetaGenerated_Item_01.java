...
//        setFluidContainerStats(32000 + tLastID, 131072000L, 1L);
        ...
        ItemList.Conveyor_Module_ULV.set(addItem(766, "Conveyor Module (ULV)", "Moves 16 items every 5 seconds.", new TC_Aspects.TC_AspectStack(TC_Aspects.ELECTRUM, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.MACHINA, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.ITER, 1L)));
        ItemList.Conveyor_Module_LV.set(addItem(630, "Conveyor Module (LV)", "Moves 16 items every 2.5 seconds.", new TC_Aspects.TC_AspectStack(TC_Aspects.ELECTRUM, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.MACHINA, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.ITER, 2L)));
        ItemList.Conveyor_Module_MV.set(addItem(631, "Conveyor Module (MV)", "Moves 32 items every 1.25 seconds.", new TC_Aspects.TC_AspectStack(TC_Aspects.ELECTRUM, 2L), new TC_Aspects.TC_AspectStack(TC_Aspects.MACHINA, 2L), new TC_Aspects.TC_AspectStack(TC_Aspects.ITER, 4L)));
        ItemList.Conveyor_Module_HV.set(addItem(632, "Conveyor Module (HV)", "Moves 32 items 2 times per second.", new TC_Aspects.TC_AspectStack(TC_Aspects.ELECTRUM, 4L), new TC_Aspects.TC_AspectStack(TC_Aspects.MACHINA, 4L), new TC_Aspects.TC_AspectStack(TC_Aspects.ITER, 6L)));
        ...
        GregTech_API.registerCover(ItemList.Conveyor_Module_ULV.get(1L), TextureFactory.of(MACHINE_CASINGS[1][0], TextureFactory.of(OVERLAY_CONVEYOR)), new GT_Cover_Conveyor(400, 1));
