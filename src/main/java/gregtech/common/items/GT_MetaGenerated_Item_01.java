...
//        GT_Values.RA.addUnboxingRecipe(ItemList.Tool_MatchBox_Full.get(1L), ItemList.Tool_Matches.get(16L), null, 32, 16);
        ...
        setElectricStats(32000 + tLastID, 80000L, GT_Values.V[1], 1L, -2L, true);
        ...
        setElectricStats(32000 + tLastID, 320000L, GT_Values.V[2], 2L, -2L, true);
        ...
        setElectricStats(32000 + tLastID, 1280000, GT_Values.V[3], 3L, -2L, true);
...
//        GT_ModHandler.addCraftingRecipe(ItemList.Robot_Arm_IV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"CCC", "MSM", "PES", 'S', OrePrefixes.stick.get(Materials.TungstenSteel), 'M', ItemList.Electric_Motor_IV, 'P', ItemList.Electric_Piston_IV, 'E', circuitLogic.get(LOGIC_IV), 'C', OrePrefixes.cableGt01.get(Materials.Tungsten)});
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Emitter_LV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"SSC", "WQS", "CWS", 'Q', OrePrefixes.gem.get(Quartz), 'S', OrePrefixes.stick.get(Materials.Steel), 'C', circuitLogic.get(PWR_LV), 'W', OrePrefixes.cableGt01.get(Materials.Tin)});
...
//        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 1L), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iridium, 1L), GT_Utility.getIntegratedCircuit(1)}, GT_Values.NF, ItemList.Upgrade_Lock.get(1L), 6400, 16);
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Tool_Scanner.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"EPR", "CSC", "PBP", 'C', circuitLogic.get(LOGIC_LV), 'P', OrePrefixes.plate.get(Steel), 'E', ItemList.Emitter_LV, 'R', ItemList.Emitter_LV, 'S', ItemList.Cover_Screen, 'B', ItemList.Battery_RE_ULV_Redstone});
