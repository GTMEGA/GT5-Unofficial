...
public class GT_Tool_WireCutter extends GT_Tool {
    ...
    public String getMiningSound() {
        return GregTech_API.sSoundList.get(109);
    }
    ...
    public IChatComponent getDeathMessage(EntityLivingBase aPlayer, EntityLivingBase aEntity) {
        return new ChatComponentText(
                EnumChatFormatting.GREEN + aPlayer.getCommandSenderName() + EnumChatFormatting.WHITE + " has cut the Cable for the Life Support Machine of " +
