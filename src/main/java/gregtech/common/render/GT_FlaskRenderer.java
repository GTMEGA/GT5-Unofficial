    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        if (fs != null) {
            ...
            if (type.equals(ItemRenderType.INVENTORY)) {
                GT_RenderUtil.renderItemIcon(iconWindow, 16.0D, 0.0D, 0.0F, 0.0F, -1.0F);
            } else {
                GT_RenderUtil.renderItemIcon(iconWindow, 1.0D, -0.001D, 0.0F, 0.0F, 1.0F);
                GT_RenderUtil.renderItemIcon(iconWindow, 1.0D, -0.0615D, 0.0F, 0.0F, -1.0F);
            }
            ...
            if (type.equals(ItemRenderType.INVENTORY)) {
                GT_RenderUtil.renderItemIcon(fluidicon, 16.0D, 0.0D, 0.0F, 0.0F, -1.0F);
            } else {
                GT_RenderUtil.renderItemIcon(fluidicon, 1.0D, -0.001D, 0.0F, 0.0F, 1.0F);
                GT_RenderUtil.renderItemIcon(fluidicon, 1.0D, -0.0615D, 0.0F, 0.0F, -1.0F);
            }
