...
public abstract class GT_Item_Casings_Abstract extends ItemBlock {
    ...
    protected final String mCoilOverheated2Tooltip = GT_LanguageManager.addStringLocalization(
            "gt.coil.overheated2.tooltip", "Place in crafting grid to get regular coils");
