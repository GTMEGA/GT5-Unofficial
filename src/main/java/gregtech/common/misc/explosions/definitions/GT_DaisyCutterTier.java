...
enum GT_DaisyCutterTier implements IGT_ExplosiveTier<GT_DaisyCutterTier> {
    ...
    MK1("Daisy Cutter Mk 1", ExplosiveTextureInfo.getOld(), ExplosiveFlavorInfo.builder().build(), DaisyCutterParameters.get(64.0).build()),
    MK2("Daisy Cutter Mk 2", ExplosiveTextureInfo.getOld(), ExplosiveFlavorInfo.builder().build(), DaisyCutterParameters.get(96.0).build()),
    MK3("Daisy Cutter Mk 3", ExplosiveTextureInfo.getNew("mk3"), ExplosiveFlavorInfo.builder().build(), DaisyCutterParameters.get(128.0).magic(true).build()),
    ;
