...
enum GT_MiningExplosiveTier implements IGT_ExplosiveTier<GT_MiningExplosiveTier> {
    MK1("§7Mining Explosive MKI§r", ExplosiveTextureInfo.getNew("mk1"), ExplosiveFlavorInfo.builder().build(), MiningExplosiveParameters.getDefaults(4.5f, 4).build()),
    MK2("§eMining Explosive MKII§r", ExplosiveTextureInfo.getNew("mk2"), ExplosiveFlavorInfo.builder().build(), MiningExplosiveParameters.getDefaults(5.5f, 5).build()),
    MK3("§cMining Explosive MKIII§r", ExplosiveTextureInfo.getNew("mk3"), ExplosiveFlavorInfo.builder().build(), MiningExplosiveParameters.getDefaults(6.0f, 6).magic(true).build()),
    ;
