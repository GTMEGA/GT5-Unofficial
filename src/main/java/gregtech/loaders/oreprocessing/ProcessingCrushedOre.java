		...
		switch (aPrefix) {
			...
			case crushedPurified:
				GT_ModHandler.addThermalCentrifugeRecipe(GT_Utility.copyAmount(1L, aStack),
                                                         ...
                                                         GT_OreDictUnificator.get(aPrefix == OrePrefixes.crushed ? OrePrefixes.crushedCentrifuged : OrePrefixes.crushedCentrifuged, aMaterial, 1L),
                                                         GT_OreDictUnificator.get(OrePrefixes.crushedCentrifuged, GT_Utility.selectItemInList(1, aMaterial.mMacerateInto, aMaterial.mOreByProducts), 1L));
				...
				switch (aMaterial.mName) {
                    ...
                    case "GarnetYellow":
						GT_Values.RA.addSifterRecipe(GT_Utility.copyAmount(1L, aStack),
                                                     ...
                                                     new int[] {500, 2000, 2000, 3000, 5000, 7500},
                                                     800,
                                                     16);
						break;
					case "Coal":
						GT_Values.RA.addSifterRecipe(GT_OreDictUnificator.get(OrePrefixes.crushedPurified, Materials.Coal, 1L),
                                                     new ItemStack[] { new ItemStack(Items.coal, 1, 0), new ItemStack(Items.coal, 1, 0), new ItemStack(Items.coal, 1, 0), new ItemStack(Items.coal, 1, 0), new ItemStack(Items.coal, 1, 0), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Thorium, 1L) },
                                                     new int[] { 10000, 9000, 8000, 7000, 6000, 250 },
                                                     360,
                                                     16);
							break;
					default:
						GT_Values.RA.addSifterRecipe(GT_Utility.copyAmount(1L, aStack),
                                                     new ItemStack[] { GT_OreDictUnificator.get(OrePrefixes.gemExquisite, aMaterial, tGem, 1L), GT_OreDictUnificator.get(OrePrefixes.gemFlawless, aMaterial, tGem, 1L), tGem, GT_OreDictUnificator.get(OrePrefixes.gemFlawed, aMaterial, tGem, 1L), GT_OreDictUnificator.get(OrePrefixes.gemChipped, aMaterial, tGem, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, aMaterial, tGem, 1L) },
                                                     new int[] { 500, 2000, 2000, 3000, 5000, 7500 },
                                                     800,
                                                     16);
				}}
