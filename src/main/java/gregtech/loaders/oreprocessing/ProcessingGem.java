        ...
        switch (aPrefix) {
            case gem:
                ...
                if (!aNoSmelting) {
                    ...
                    GT_Values.RA.addForgeHammerRecipe(GT_Utility.copyAmount(1L, aStack), GT_OreDictUnificator.get(OrePrefixes.dust, aMaterial, 1L), (int) Math.max(aMaterialMass, 1L), 16);
                }
