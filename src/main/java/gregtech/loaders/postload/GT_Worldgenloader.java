...
//            new GT_Worldgen_GT_Ore_SmallPieces("ore.small.lapis", true, 3, 35, 8, true, false, false, false, true, true, Materials.Lapis);
            ...
            new GT_Worldgen_GT_Ore_Layer(OreVein.zinc.unlocalizedName(), true, 70, 80, 150, 6, 32, true, false, false, Materials.Zinc, Materials.Tin, Materials.Sphalerite, Materials.Cassiterite);
            new GT_Worldgen_GT_Ore_Layer(OreVein.tin.unlocalizedName(), true, 55, 60, 50, 4, 32, true, false, false, Materials.Tin, Materials.Zinc, Materials.Cassiterite, Materials.Chalcopyrite);
            ...
            new GT_Worldgen_GT_Ore_Layer(OreVein.salts.unlocalizedName(), true, 40, 45, 50, 2, 24, true, false, false, Materials.Salt, Materials.Saltpeter, Materials.Spodumene, Materials.Salt);
