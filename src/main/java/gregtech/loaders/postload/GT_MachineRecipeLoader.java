...
//        }
    ...
    private void loadRailcraftRecipes() {
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.AnyIron, 2L), GT_Utility.getIntegratedCircuit(20), GT_ModHandler.getModItem(MOD_ID_RC, "machine.beta", 1L, 0), 50, 30);
