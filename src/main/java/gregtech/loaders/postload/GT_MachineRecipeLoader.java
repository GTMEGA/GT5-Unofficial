...
//            	GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1)}, new FluidStack[]{Materials.Benzene.getFluid(1000), Materials.Methane.getGas(1000)}, new FluidStack[]{Materials.Dimethylbenzene.getFluid(1000L)}, null, 4000, 120);
    ...
    public static void addBusAndHatchRecipes(){
        ...
        for (int aTier = 0; aTier < 10; aTier++) {
            ...
            if (aTier<2) {
                GT_Values.RA.addAssemblerRecipe(aInputs[aTier], glues[0].getFluid((long)(100 * Math.pow((aTier + 4), aTier))), ItemList.HATCHES_INPUT_BUS[aTier].get(1L), 100, (int) (30 * Math.pow(4, (aTier - 1))), false);
                GT_Values.RA.addAssemblerRecipe(aInputs2[aTier], glues[0].getFluid((long)(100 * Math.pow((aTier+4), aTier))), ItemList.HATCHES_OUTPUT_BUS[aTier].get(1L), 100, (int) (30 * Math.pow(4, (aTier - 1))), false);
                GT_Values.RA.addAssemblerRecipe(flInputs[aTier], glues[0].getFluid((long)(100 * Math.pow((aTier+4), aTier))), ItemList.HATCHES_INPUT[aTier].get(1L), 100, (int) (30 * Math.pow(4, (aTier - 1))), false);
                GT_Values.RA.addAssemblerRecipe(flInputs2[aTier], glues[0].getFluid((long)(100 * Math.pow((aTier+4), aTier))), ItemList.HATCHES_OUTPUT[aTier].get(1L), 100, (int) (30 * Math.pow(4, (aTier - 1))), false);
            }
            if (aTier<4) {
