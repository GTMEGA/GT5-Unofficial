...
//        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Gold, 4L), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Tin, 9L), Materials.Plastic.getMolten(1296), ItemList.Battery_Hull_HV.get(1L), 80, 4);
        ...
        GT_Values.RA.addCentrifugeRecipe(ItemList.Resin.get(1L), GT_Values.NI, GT_Values.NF, Materials.Glue.getFluid(100L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.RawRubber, 1L), ItemList.Plantball.get(1L), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{10000, 3000}, 300, 8);
