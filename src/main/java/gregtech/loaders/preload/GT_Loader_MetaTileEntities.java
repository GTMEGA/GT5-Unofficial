...
//        addCraftingRecipe(Machine_HV_Miner.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"RPR", "WMW", "CSC", 'M', Hull_HV, 'E', Electric_Motor_HV, 'P', Electric_Piston_HV, 'R', Robot_Arm_HV, 'C', circuitLogic.get(LOGIC_HV), 'W', cableGt04.get(Gold), 'S', Sensor_HV});
    ...
    private static void loadSesmicProspector() {
        Seismic_Prospector_LV.set(new GT_MetaTileEntity_SeismicProspector(1156, "basicmachine.seismicprospector.01", "Deprecated Machine SP", 1).getStackForm(1));
        Seismic_Prospector_MV.set(new GT_MetaTileEntity_SeismicProspector(2100, "basicmachine.seismicprospector.02", "Deprecated Machine SP", 2).getStackForm(1));
        Seismic_Prospector_HV.set(new GT_MetaTileEntity_SeismicProspector(2101, "basicmachine.seismicprospector.03", "Deprecated Machine SP", 3).getStackForm(1));
