...
public final class HullLoader {
    ...
    public static void load() {
        ...
        addCraftingRecipe(Hull_MV.get(1L), REVERSIBLE, new Object[]{"CMC", 'M', Casing_MV, 'C', cableGt01.get(AnyCopper), 'H', plate.get(Aluminium), 'P', plate.get(WroughtIron)});
        addCraftingRecipe(Hull_HV.get(1L), REVERSIBLE, new Object[]{"CMC", 'M', Casing_HV, 'C', cableGt01.get(Gold), 'H', plate.get(StainlessSteel), 'P', plate.get(Plastic)});
        ...
        if (GT_Mod.gregtechproxy.mHardMachineCasings) {
            ...
            addCraftingRecipe(Hull_MV.get(1L), NOT_REMOVABLE | BUFFERED, new Object[]{"PHP", "CMC", 'M', Casing_MV, 'C', cableGt01.get(Copper), 'H', plate.get(Aluminium), 'P', plate.get(WroughtIron)});
            addCraftingRecipe(Hull_HV.get(1L), NOT_REMOVABLE | BUFFERED, new Object[]{"PHP", "CMC", 'M', Casing_HV, 'C', cableGt01.get(Gold), 'H', plate.get(StainlessSteel), 'P', plate.get(Plastic)});
