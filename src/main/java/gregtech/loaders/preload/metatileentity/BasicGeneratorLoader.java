...
public final class BasicGeneratorLoader {
    ...
    public static void load() {
        ...
        Generator_Diesel_LV.set(new GT_MetaTileEntity_DieselGenerator(1110, "basicgenerator.diesel.tier.01", "Tiny Combustion Generator MKI", 1).getStackForm(1L));
        Generator_Diesel_MV.set(new GT_MetaTileEntity_DieselGenerator(1111, "basicgenerator.diesel.tier.02", "Tiny Combustion Generator MKII", 2).getStackForm(1L));
        Generator_Diesel_HV.set(new GT_MetaTileEntity_DieselGenerator(1112, "basicgenerator.diesel.tier.03", "Tiny Combustion Generator MKIII", 3).getStackForm(1L));

        addCraftingRecipe(Generator_Diesel_LV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"PCP", "EME", "GWG", 'M', Hull_LV, 'P', Electric_Piston_LV, 'E', Electric_Motor_LV, 'C', circuitPower.get(PWR_LV), 'W', cableGt01.get(Tin), 'G', gearGtSmall.get(Steel)});
        addCraftingRecipe(Generator_Diesel_MV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"PCP", "EME", "GWG", 'M', Hull_MV, 'P', Electric_Piston_MV, 'E', Electric_Motor_MV, 'C', circuitPower.get(PWR_MV), 'W', cableGt01.get(AnyCopper), 'G', gearGtSmall.get(StainlessSteel)});
        addCraftingRecipe(Generator_Diesel_HV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"PCP", "EME", "GWG", 'M', Hull_HV, 'P', Electric_Piston_HV, 'E', Electric_Motor_HV, 'C', circuitPower.get(PWR_HV), 'W', cableGt01.get(Gold), 'G', gearGtSmall.get(Aluminium)});

        Generator_Gas_Turbine_LV.set(new GT_MetaTileEntity_GasTurbine(1115, "basicgenerator.gasturbine.tier.01", "Tiny Gas Turbine MKI", 1).getStackForm(1L));
        Generator_Gas_Turbine_MV.set(new GT_MetaTileEntity_GasTurbine(1116, "basicgenerator.gasturbine.tier.02", "Tiny Gas Turbine MKII", 2).getStackForm(1L));
        Generator_Gas_Turbine_HV.set(new GT_MetaTileEntity_GasTurbine(1117, "basicgenerator.gasturbine.tier.03", "Tiny Gas Turbine MKIII", 3).getStackForm(1L));
        ...
        Generator_Steam_Turbine_LV.set(new GT_MetaTileEntity_SteamTurbine(1120, "basicgenerator.steamturbine.tier.01", "Tiny Steam Turbine MKI", 1).getStackForm(1L));
        Generator_Steam_Turbine_MV.set(new GT_MetaTileEntity_SteamTurbine(1121, "basicgenerator.steamturbine.tier.02", "Tiny Steam Turbine MKII", 2).getStackForm(1L));
        Generator_Steam_Turbine_HV.set(new GT_MetaTileEntity_SteamTurbine(1122, "basicgenerator.steamturbine.tier.03", "Tiny Steam Turbine MKIII", 3).getStackForm(1L));
        ...
        Generator_Naquadah_Mark_I.set(new GT_MetaTileEntity_NaquadahReactor(1190, "basicgenerator.naquadah.tier.04", new String[]{"Requires Enriched Naquadah Bolts"},       "Naquadah Reactor MKI", 4).getStackForm(1L));
        Generator_Naquadah_Mark_II.set(new GT_MetaTileEntity_NaquadahReactor(1191, "basicgenerator.naquadah.tier.05", new String[]{"Requires Enriched Naquadah Rods"},       "Naquadah Reactor MKII", 5).getStackForm(1L));
        Generator_Naquadah_Mark_III.set(new GT_MetaTileEntity_NaquadahReactor(1192, "basicgenerator.naquadah.tier.06", new String[]{"Requires Enriched Naquadah Long Rods"}, "Naquadah Reactor MKIII", 6).getStackForm(1L));
        Generator_Naquadah_Mark_IV.set(new GT_MetaTileEntity_NaquadahReactor(1188, "basicgenerator.naquadah.tier.07", new String[]{"Requires Naquadria Bolts"},              "Naquadah Reactor MKIV", 7).getStackForm(1L));
        Generator_Naquadah_Mark_V.set(new GT_MetaTileEntity_NaquadahReactor(1189, "basicgenerator.naquadah.tier.08", new String[]{"Requires Naquadria Rods"},                "Naquadah Reactor MKV", 8).getStackForm(1L));
