...
public final class BasicGeneratorLoader {
    ...
    public static void load() {
        ...
        addCraftingRecipe(Generator_Diesel_LV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"PCP", "EME", "GWG", 'M', Hull_LV, 'P', Electric_Piston_LV, 'E', Electric_Motor_LV, 'C', pwrcircuit.get(PWR_LV), 'W', cableGt01.get(Tin), 'G', gearGt.get(Steel)});
        addCraftingRecipe(Generator_Diesel_MV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"PCP", "EME", "GWG", 'M', Hull_MV, 'P', Electric_Piston_MV, 'E', Electric_Motor_MV, 'C', pwrcircuit.get(PWR_MV), 'W', cableGt01.get(AnyCopper), 'G', gearGt.get(Aluminium)});
        addCraftingRecipe(Generator_Diesel_HV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"PCP", "EME", "GWG", 'M', Hull_HV, 'P', Electric_Piston_HV, 'E', Electric_Motor_HV, 'C', pwrcircuit.get(PWR_HV), 'W', cableGt01.get(Gold), 'G', gearGt.get(StainlessSteel)});
        ...
        addCraftingRecipe(Generator_Gas_Turbine_LV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CRC", "RMR", "EWE", 'M', Hull_LV, 'E', Electric_Motor_LV, 'R', rotor.get(Tin), 'C', pwrcircuit.get(PWR_LV), 'W', cableGt01.get(Tin)});
        addCraftingRecipe(Generator_Gas_Turbine_MV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CRC", "RMR", "EWE", 'M', Hull_MV, 'E', Electric_Motor_MV, 'R', rotor.get(Bronze), 'C', pwrcircuit.get(PWR_MV), 'W', cableGt01.get(AnyCopper)});
        addCraftingRecipe(Generator_Gas_Turbine_HV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CRC", "RMR", "EWE", 'M', Hull_HV, 'E', Electric_Motor_HV, 'R', rotor.get(Steel), 'C', pwrcircuit.get(PWR_HV), 'W', cableGt01.get(Gold)});
        ...
        addCraftingRecipe(Generator_Steam_Turbine_LV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"PCP", "RMR", "EWE", 'M', Hull_LV, 'E', Electric_Motor_LV, 'R', rotor.get(Tin), 'C', pwrcircuit.get(PWR_LV), 'W', cableGt01.get(Tin), 'P', pipeMedium.get(Bronze)});
        addCraftingRecipe(Generator_Steam_Turbine_MV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"PCP", "RMR", "EWE", 'M', Hull_MV, 'E', Electric_Motor_MV, 'R', rotor.get(Bronze), 'C', pwrcircuit.get(PWR_MV), 'W', cableGt01.get(AnyCopper), 'P', pipeMedium.get(Steel)});
        addCraftingRecipe(Generator_Steam_Turbine_HV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"PCP", "RMR", "EWE", 'M', Hull_HV, 'E', Electric_Motor_HV, 'R', rotor.get(Steel), 'C', pwrcircuit.get(PWR_HV), 'W', cableGt01.get(Gold), 'P', pipeMedium.get(StainlessSteel)});
        ...
        if (!Loader.isModLoaded("Thaumcraft")) {
            addCraftingRecipe(MagicEnergyConverter_LV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CTC", "FMF", "CBC", 'M', Hull_LV, 'B', new ItemStack(Blocks.beacon), 'C', pwrcircuit.get(PWR_MV), 'T', Field_Generator_LV, 'F', plate.get(Platinum)});
            addCraftingRecipe(MagicEnergyConverter_MV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CTC", "FMF", "CBC", 'M', Hull_MV, 'B', new ItemStack(Blocks.beacon), 'C', pwrcircuit.get(PWR_HV), 'T', Field_Generator_MV, 'F', plate.get(Iridium)});
            addCraftingRecipe(MagicEnergyConverter_HV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CTC", "FMF", "CBC", 'M', Hull_HV, 'B', new ItemStack(Blocks.beacon), 'C', pwrcircuit.get(PWR_EV), 'T', Field_Generator_HV, 'F', plate.get(Neutronium)});

            addCraftingRecipe(MagicEnergyAbsorber_LV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CTC", "FMF", "CBC", 'M', Hull_LV, 'B', MagicEnergyConverter_LV.get(1L), 'C', pwrcircuit.get(PWR_MV), 'T', Field_Generator_LV, 'F', plate.get(Platinum)});
            addCraftingRecipe(MagicEnergyAbsorber_MV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CTC", "FMF", "CBC", 'M', Hull_MV, 'B', MagicEnergyConverter_MV.get(1L), 'C', pwrcircuit.get(PWR_HV), 'T', Field_Generator_MV, 'F', plate.get(Iridium)});
            addCraftingRecipe(MagicEnergyAbsorber_HV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CTC", "FMF", "CBC", 'M', Hull_HV, 'B', MagicEnergyConverter_MV.get(1L), 'C', pwrcircuit.get(PWR_EV), 'T', Field_Generator_HV, 'F', plate.get(Europium)});
            addCraftingRecipe(MagicEnergyAbsorber_EV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CTC", "FMF", "CBC", 'M', Hull_HV, 'B', MagicEnergyConverter_HV.get(1L), 'C', pwrcircuit.get(PWR_IV), 'T', Field_Generator_EV, 'F', plate.get(Neutronium)});
        }
        ...
        addCraftingRecipe(Generator_Plasma_IV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"UCU", "FMF", "WCW", 'M', Hull_LuV, 'F', Field_Generator_HV, 'C', pwrcircuit.get(PWR_IV), 'W', cableGt04.get(Tungsten), 'U', stick.get(Plutonium241)});
        addCraftingRecipe(Generator_Plasma_LuV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"UCU", "FMF", "WCW", 'M', Hull_ZPM, 'F', Field_Generator_EV, 'C', pwrcircuit.get(PWR_LUV), 'W', wireGt04.get(VanadiumGallium), 'U', stick.get(Europium)});
        addCraftingRecipe(Generator_Plasma_ZPMV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"UCU", "FMF", "WCW", 'M', Hull_UV, 'F', Field_Generator_IV, 'C', pwrcircuit.get(PWR_ZPM), 'W', wireGt04.get(Naquadah), 'U', stick.get(Americium)});
        LOADED = true;
    }
}
