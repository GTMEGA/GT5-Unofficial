...
public final class HatchLoader {
    ...
    public static void load() {
        ...
        addCraftingRecipe(Hatch_Dynamo_ULV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"XOL", "SMP", "XOL", 'M', Hull_ULV, 'S', spring.get(Tin), 'X', circuit.get(Primitive), 'O', ULV_Coil, 'L', cell.get(Lubricant), 'P', rotor.get(Tin)});
        addCraftingRecipe(Hatch_Dynamo_LV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"XOL", "SMP", "XOL", 'M', Hull_LV, 'S', spring.get(Tin), 'X', circuit.get(Basic), 'O', LV_Coil, 'L', cell.get(Lubricant), 'P', Electric_Pump_LV});
        addCraftingRecipe(Hatch_Dynamo_MV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"XOL", "SMP", "XOL", 'M', Hull_MV, 'S', spring.get(Copper), 'X', Circuit_Chip_ULPIC, 'O', MV_Coil, 'L', cell.get(Lubricant), 'P', Electric_Pump_MV});
        ...
        addCraftingRecipe(Hatch_Energy_ULV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"COL", "XMP", "COL", 'M', Hull_ULV, 'C', cableGt01.get(RedAlloy), 'X', circuit.get(Primitive), 'O', ULV_Coil, 'L', cell.get(Lubricant), 'P', rotor.get(Tin)});
        addCraftingRecipe(Hatch_Energy_LV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"COL", "XMP", "COL", 'M', Hull_LV, 'C', cableGt01.get(Tin), 'X', circuit.get(Basic), 'O', LV_Coil, 'L', cell.get(Lubricant), 'P', Electric_Pump_LV});
        addCraftingRecipe(Hatch_Energy_MV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"XOL", "CMP", "XOL", 'M', Hull_MV, 'C', cableGt01.get(Copper), 'X', Circuit_Chip_ULPIC, 'O', MV_Coil, 'L', cell.get(Lubricant), 'P', Electric_Pump_MV});
        ...
        addCraftingRecipe(Hatch_DataAccess_EV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"COC", "OMO", "COC", 'M', Hull_EV, 'O', Tool_DataStick, 'C', circuit.get(Elite)});
        addCraftingRecipe(Hatch_DataAccess_LuV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"COC", "OMO", "COC", 'M', Hull_LuV, 'O', Tool_DataOrb, 'C', circuit.get(Ultimate)});
        addCraftingRecipe(Hatch_DataAccess_UV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CRC", "OMO", "CRC", 'M', Hull_UV, 'O', Tool_DataOrb, 'C', circuit.get(Infinite), 'R', Robot_Arm_UV});

        addCraftingRecipe(Hatch_AutoMaintenance.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CHC", "AMA", "CHC", 'M', Hull_LuV, 'H', Hatch_Maintenance, 'A', Robot_Arm_LuV, 'C', circuit.get(Ultimate)});
