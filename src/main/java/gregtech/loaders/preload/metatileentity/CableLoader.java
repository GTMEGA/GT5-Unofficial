...
public final class CableLoader {
    ...
    public static void load() {
        ...
        makeWires(Copper, 1360, extraLoss ? 2L : 3L, extraLoss ? 4L : 6L, 1L, V[2], true, false);
        makeWires(AnnealedCopper, 1380, extraLoss ? 1L : 2L, extraLoss ? 2L : 4L, 1L, V[2], true, false);

        makeWires(Kanthal, 1400, extraLoss ? 3L : 8L, extraLoss ? 6L : 16L, 4L, V[3], true, false);
        makeWires(Gold, 1420, extraLoss ? 2L : 6L, extraLoss ? 4L : 12L, 3L, V[3], true, false);
        makeWires(Electrum, 1440, extraLoss ? 2L : 5L, extraLoss ? 4L : 10L, 2L, V[3], true, false);
        makeWires(Silver, 1460, extraLoss ? 1L : 4L, extraLoss ? 2L : 8L, 1L, V[3], true, false);
        makeWires(BlueAlloy, 1480, extraLoss ? 1L : 4L, extraLoss ? 2L : 8L, 2L, V[3], true, false);

        makeWires(Nichrome, 1500, extraLoss ? 4L : 32L, extraLoss ? 8L : 64L, 3L, V[4], true, false);
        ...
        makeWires(Titanium, 1560, extraLoss ? 2L : 12L, extraLoss ? 4L : 24L, 4L, V[4], true, false);
        makeWires(Aluminium, 1580, extraLoss ? 1L : 8L, extraLoss ? 2L : 16L, 1L, V[4], true, false);

        makeWires(Graphene, 1600, extraLoss ? 1L : 16L, extraLoss ? 2L : 32L, 1L, V[5], false, true);
        ...
        makeWires(TungstenSteel, 1660, extraLoss ? 2L : 14L, extraLoss ? 4L : 28L, 3L, V[5], true, false);
        makeWires(Tungsten, 1680, extraLoss ? 2L : 12L, extraLoss ? 4L : 24L, 2L, V[5], true, false);

        makeWires(HSSG, 1700, extraLoss ? 2L : 128L, extraLoss ? 4L : 256L, 4L, V[6], true, false);
        makeWires(NiobiumTitanium, 1720, extraLoss ? 2L : 128L, extraLoss ? 4L : 256L, 4L, V[6], true, false);
        makeWires(VanadiumGallium, 1740, extraLoss ? 2L : 128L, extraLoss ? 4L : 256L, 4L, V[6], true, false);
        makeWires(YttriumBariumCuprate, 1760, extraLoss ? 4L : 256L, extraLoss ? 8L : 512L, 4L, V[6], true, false);

        makeWires(Naquadah, 1780, extraLoss ? 2L : 64L, extraLoss ? 4L : 128L, 2L, V[7], true, false);

        makeWires(NaquadahAlloy, 1800, extraLoss ? 4L : 64L, extraLoss ? 8L : 128L, 2L, V[8], true, false);
        makeWires(Duranium, 1820, extraLoss ? 8L : 64L, extraLoss ? 16L : 128L, 1L, V[8], true, false);

        makeWires(SuperconductorUHV, 2020, 0L, 0L, 16L, V[9], false, true);
        makeWires(Pentacadmiummagnesiumhexaoxid, 2200, extraLoss ? 1L : 128L, extraLoss ? 2L : 256L, 1L, V[2], true, false);
        makeWires(Titaniumonabariumdecacoppereikosaoxid, 2220, extraLoss ? 1L : 128L, extraLoss ? 2L : 256L, 1L, V[3], true, false);
        makeWires(Uraniumtriplatinid, 2240, extraLoss ? 1L : 128L, extraLoss ? 2L : 256L, 2L, V[4], true, false);
        makeWires(Vanadiumtriindinid, 2260, extraLoss ? 1L : 128L, extraLoss ? 2L : 256L, 2L, V[5], true, false);
        makeWires(Tetraindiumditindibariumtitaniumheptacoppertetrakaidekaoxid, 2280, 2L, 2L, 4L, V[6], true, false);
        makeWires(Tetranaquadahdiindiumhexaplatiumosminid, 2300, 2L, 2L, 4L, V[7], true, false);
        makeWires(Longasssuperconductornameforuvwire, 2500, 2L, 2L, 8L, V[8], true, false);
        makeWires(Longasssuperconductornameforuhvwire, 2520, 2L, 2L, 12L, V[9], true, false);
        makeWires(SuperconductorMV, 2320, 0L, 0L, 2L, V[2], false, true);
        makeWires(SuperconductorHV, 2340, 0L, 0L, 2L, V[3], false, true);
        makeWires(SuperconductorEV, 2360, 0L, 0L, 4L, V[4], false, true);
        makeWires(SuperconductorIV, 2380, 0L, 0L, 4L, V[5], false, true);
        makeWires(SuperconductorLuV, 2400, 0L, 0L, 8L, V[6], false, true);
        makeWires(SuperconductorZPM, 2420, 0L, 0L, 8L, V[7], false, true);
        makeWires(SuperconductorUV, 2440, 0L, 0L, 16L, V[8], false, true);
