...
public final class ItemStuffLoader {
    ...
    public static void load() {
        ...
        addCraftingRecipe(
                Automation_ChestBuffer_ULV.get(1L), bitsd,
                new Object[]{"CMV", " X ", 'M', Hull_ULV, 'V', Conveyor_Module_LV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_LV)}
                         );
        addCraftingRecipe(
                Automation_ChestBuffer_LV.get(1L), bitsd,
                new Object[]{"CMV", " X ", 'M', Hull_LV, 'V', Conveyor_Module_LV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_LV)}
                         );
        addCraftingRecipe(
                Automation_ChestBuffer_MV.get(1L), bitsd,
                new Object[]{"CMV", " X ", 'M', Hull_MV, 'V', Conveyor_Module_MV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_MV)}
                         );
        addCraftingRecipe(
                Automation_ChestBuffer_HV.get(1L), bitsd,
                new Object[]{"CMV", " X ", 'M', Hull_HV, 'V', Conveyor_Module_HV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_HV)}
                         );
        addCraftingRecipe(
                Automation_ChestBuffer_EV.get(1L), bitsd,
                new Object[]{"CMV", " X ", 'M', Hull_EV, 'V', Conveyor_Module_EV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_EV)}
                         );
        addCraftingRecipe(
                Automation_ChestBuffer_IV.get(1L), bitsd,
                new Object[]{"CMV", " X ", 'M', Hull_IV, 'V', Conveyor_Module_IV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_IV)}
                         );
        addCraftingRecipe(
                Automation_ChestBuffer_LuV.get(1L), bitsd,
                new Object[]{"CMV", " X ", 'M', Hull_LuV, 'V', Conveyor_Module_LuV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_LUV)}
                         );
        addCraftingRecipe(
                Automation_ChestBuffer_ZPM.get(1L), bitsd,
                new Object[]{"CMV", " X ", 'M', Hull_ZPM, 'V', Conveyor_Module_ZPM, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_ZPM)}
                         );
        addCraftingRecipe(
                Automation_ChestBuffer_UV.get(1L), bitsd,
                new Object[]{"CMV", " X ", 'M', Hull_UV, 'V', Conveyor_Module_UV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_UV)}
                         );
        addCraftingRecipe(
                Automation_ChestBuffer_MAX.get(1L), bitsd,
                new Object[]{"CMV", " X ", 'M', Hull_MAX, 'V', Conveyor_Module_UHV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_UHV)}
                         );
        ...
        addCraftingRecipe(
                Automation_Filter_ULV.get(1L), bitsd, new Object[]{
                        " F ", "CMV", " X ", 'M', Hull_ULV, 'V', Electric_Motor_LV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Filter_LV.get(1L), bitsd, new Object[]{
                        " F ", "CMV", " X ", 'M', Hull_LV, 'V', Conveyor_Module_LV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Filter_MV.get(1L), bitsd, new Object[]{
                        " F ", "CMV", " X ", 'M', Hull_MV, 'V', Conveyor_Module_MV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Filter_HV.get(1L), bitsd, new Object[]{
                        " F ", "CMV", " X ", 'M', Hull_HV, 'V', Conveyor_Module_HV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Filter_EV.get(1L), bitsd, new Object[]{
                        " F ", "CMV", " X ", 'M', Hull_EV, 'V', Conveyor_Module_EV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Filter_IV.get(1L), bitsd, new Object[]{
                        " F ", "CMV", " X ", 'M', Hull_IV, 'V', Conveyor_Module_IV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Filter_LuV.get(1L), bitsd, new Object[]{
                        " F ", "CMV", " X ", 'M', Hull_LuV, 'V', Conveyor_Module_LuV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Filter_ZPM.get(1L), bitsd, new Object[]{
                        " F ", "CMV", " X ", 'M', Hull_ZPM, 'V', Conveyor_Module_ZPM, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Filter_UV.get(1L), bitsd, new Object[]{
                        " F ", "CMV", " X ", 'M', Hull_UV, 'V', Conveyor_Module_UV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Filter_MAX.get(1L), bitsd, new Object[]{
                        " F ", "CMV", " X ", 'M', Hull_MAX, 'V', Conveyor_Module_UHV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        ...
        addCraftingRecipe(
                Automation_TypeFilter_ULV.get(1L), bitsd, new Object[]{
                        " F ", "VMC", " X ", 'M', Hull_ULV, 'V', Conveyor_Module_LV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_TypeFilter_LV.get(1L), bitsd, new Object[]{
                        " F ", "VMC", " X ", 'M', Hull_LV, 'V', Conveyor_Module_LV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_TypeFilter_MV.get(1L), bitsd, new Object[]{
                        " F ", "VMC", " X ", 'M', Hull_MV, 'V', Conveyor_Module_MV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_TypeFilter_HV.get(1L), bitsd, new Object[]{
                        " F ", "VMC", " X ", 'M', Hull_HV, 'V', Conveyor_Module_HV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_TypeFilter_EV.get(1L), bitsd, new Object[]{
                        " F ", "VMC", " X ", 'M', Hull_EV, 'V', Conveyor_Module_EV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_TypeFilter_IV.get(1L), bitsd, new Object[]{
                        " F ", "VMC", " X ", 'M', Hull_IV, 'V', Conveyor_Module_IV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_TypeFilter_LuV.get(1L), bitsd, new Object[]{
                        " F ", "VMC", " X ", 'M', Hull_LuV, 'V', Conveyor_Module_LuV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_TypeFilter_ZPM.get(1L), bitsd, new Object[]{
                        " F ", "VMC", " X ", 'M', Hull_ZPM, 'V', Conveyor_Module_ZPM, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_TypeFilter_UV.get(1L), bitsd, new Object[]{
                        " F ", "VMC", " X ", 'M', Hull_UV, 'V', Conveyor_Module_UV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_TypeFilter_MAX.get(1L), bitsd, new Object[]{
                        " F ", "VMC", " X ", 'M', Hull_MAX, 'V', Conveyor_Module_UHV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        ...
        addCraftingRecipe(
                Automation_Regulator_ULV.get(1L), bitsd, new Object[]{
                        "XFX", "VMV", "XCX", 'M', Hull_ULV, 'V', Robot_Arm_LV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Regulator_LV.get(1L), bitsd, new Object[]{
                        "XFX", "VMV", "XCX", 'M', Hull_LV, 'V', Robot_Arm_LV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Regulator_MV.get(1L), bitsd, new Object[]{
                        "XFX", "VMV", "XCX", 'M', Hull_MV, 'V', Robot_Arm_MV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Regulator_HV.get(1L), bitsd, new Object[]{
                        "XFX", "VMV", "XCX", 'M', Hull_HV, 'V', Robot_Arm_HV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Regulator_EV.get(1L), bitsd, new Object[]{
                        "XFX", "VMV", "XCX", 'M', Hull_EV, 'V', Robot_Arm_EV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Regulator_IV.get(1L), bitsd, new Object[]{
                        "XFX", "VMV", "XCX", 'M', Hull_IV, 'V', Robot_Arm_IV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Regulator_LuV.get(1L), bitsd, new Object[]{
                        "XFX", "VMV", "XCX", 'M', Hull_LuV, 'V', Robot_Arm_LuV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Regulator_ZPM.get(1L), bitsd, new Object[]{
                        "XFX", "VMV", "XCX", 'M', Hull_ZPM, 'V', Robot_Arm_ZPM, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Regulator_UV.get(1L), bitsd, new Object[]{
                        "XFX", "VMV", "XCX", 'M', Hull_UV, 'V', Robot_Arm_UV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        addCraftingRecipe(
                Automation_Regulator_MAX.get(1L), bitsd, new Object[]{
                        "XFX", "VMV", "XCX", 'M', Hull_MAX, 'V', Robot_Arm_UHV, 'C', craftingChest, 'F', craftingFilter, 'X', circuitLogic.get(LOGIC_LV)
                });
        ...
        addCraftingRecipe(
                Automation_SuperBuffer_ULV.get(1L), bitsd, new Object[]{"DMV", 'M', Automation_ChestBuffer_ULV, 'V', Conveyor_Module_LV, 'D', Tool_DataOrb});
        addCraftingRecipe(
                Automation_SuperBuffer_LV.get(1L), bitsd, new Object[]{"DMV", 'M', Automation_ChestBuffer_LV, 'V', Conveyor_Module_LV, 'D', Tool_DataOrb});
        addCraftingRecipe(
                Automation_SuperBuffer_MV.get(1L), bitsd, new Object[]{"DMV", 'M', Automation_ChestBuffer_MV, 'V', Conveyor_Module_MV, 'D', Tool_DataOrb});
        addCraftingRecipe(
                Automation_SuperBuffer_HV.get(1L), bitsd, new Object[]{"DMV", 'M', Automation_ChestBuffer_HV, 'V', Conveyor_Module_HV, 'D', Tool_DataOrb});
        addCraftingRecipe(
                Automation_SuperBuffer_EV.get(1L), bitsd, new Object[]{"DMV", 'M', Automation_ChestBuffer_EV, 'V', Conveyor_Module_EV, 'D', Tool_DataOrb});
        addCraftingRecipe(
                Automation_SuperBuffer_IV.get(1L), bitsd, new Object[]{"DMV", 'M', Automation_ChestBuffer_IV, 'V', Conveyor_Module_IV, 'D', Tool_DataOrb});
        addCraftingRecipe(
                Automation_SuperBuffer_LuV.get(1L), bitsd, new Object[]{"DMV", 'M', Automation_ChestBuffer_LuV, 'V', Conveyor_Module_LuV, 'D', Tool_DataOrb});
        addCraftingRecipe(
                Automation_SuperBuffer_ZPM.get(1L), bitsd, new Object[]{"DMV", 'M', Automation_ChestBuffer_ZPM, 'V', Conveyor_Module_ZPM, 'D', Tool_DataOrb});
        addCraftingRecipe(
                Automation_SuperBuffer_UV.get(1L), bitsd, new Object[]{"DMV", 'M', Automation_ChestBuffer_UV, 'V', Conveyor_Module_UV, 'D', Tool_DataOrb});
        addCraftingRecipe(
                Automation_SuperBuffer_MAX.get(1L), bitsd, new Object[]{"DMV", 'M', Automation_ChestBuffer_MAX, 'V', Conveyor_Module_UHV, 'D', Tool_DataOrb});
        ...
        Automation_ItemDistributor_ULV.set(
                new GT_MetaTileEntity_ItemDistributor(9320, "automation.itemdistributor.tier.00", "ULV Item Distributor", 0).getStackForm(1L));
        Automation_ItemDistributor_LV.set(
                new GT_MetaTileEntity_ItemDistributor(9321, "automation.itemdistributor.tier.01", "LV Item Distributor", 1).getStackForm(1L));
        Automation_ItemDistributor_MV.set(
                new GT_MetaTileEntity_ItemDistributor(9322, "automation.itemdistributor.tier.02", "MV Item Distributor", 2).getStackForm(1L));
        Automation_ItemDistributor_HV.set(
                new GT_MetaTileEntity_ItemDistributor(9323, "automation.itemdistributor.tier.03", "HV Item Distributor", 3).getStackForm(1L));
        Automation_ItemDistributor_EV.set(
                new GT_MetaTileEntity_ItemDistributor(9324, "automation.itemdistributor.tier.04", "EV Item Distributor", 4).getStackForm(1L));
        Automation_ItemDistributor_IV.set(
                new GT_MetaTileEntity_ItemDistributor(9325, "automation.itemdistributor.tier.05", "IV Item Distributor", 5).getStackForm(1L));
        Automation_ItemDistributor_LuV.set(
                new GT_MetaTileEntity_ItemDistributor(9326, "automation.itemdistributor.tier.06", "LuV Item Distributor", 6).getStackForm(1L));
        Automation_ItemDistributor_ZPM.set(
                new GT_MetaTileEntity_ItemDistributor(9327, "automation.itemdistributor.tier.07", "ZPM Item Distributor", 7).getStackForm(1L));
        Automation_ItemDistributor_UV.set(
                new GT_MetaTileEntity_ItemDistributor(9328, "automation.itemdistributor.tier.08", "UV Item Distributor", 8).getStackForm(1L));
        Automation_ItemDistributor_MAX.set(
                new GT_MetaTileEntity_ItemDistributor(9329, "automation.itemdistributor.tier.09", "UHV Item Distributor", 9).getStackForm(1L));

        addCraftingRecipe(
                Automation_ItemDistributor_ULV.get(1L), bitsd,
                new Object[]{"XCX", "VMV", " V ", 'M', Hull_ULV, 'V', Conveyor_Module_LV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_LV)}
                         );
        addCraftingRecipe(
                Automation_ItemDistributor_LV.get(1L), bitsd,
                new Object[]{"XCX", "VMV", " V ", 'M', Hull_LV, 'V', Conveyor_Module_LV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_LV)}
                         );
        addCraftingRecipe(
                Automation_ItemDistributor_MV.get(1L), bitsd,
                new Object[]{"XCX", "VMV", " V ", 'M', Hull_MV, 'V', Conveyor_Module_MV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_LV)}
                         );
        addCraftingRecipe(
                Automation_ItemDistributor_HV.get(1L), bitsd,
                new Object[]{"XCX", "VMV", " V ", 'M', Hull_HV, 'V', Conveyor_Module_HV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_LV)}
                         );
        addCraftingRecipe(
                Automation_ItemDistributor_EV.get(1L), bitsd,
                new Object[]{"XCX", "VMV", " V ", 'M', Hull_EV, 'V', Conveyor_Module_EV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_LV)}
                         );
        addCraftingRecipe(
                Automation_ItemDistributor_IV.get(1L), bitsd,
                new Object[]{"XCX", "VMV", " V ", 'M', Hull_IV, 'V', Conveyor_Module_IV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_LV)}
                         );
        addCraftingRecipe(
                Automation_ItemDistributor_LuV.get(1L), bitsd,
                new Object[]{"XCX", "VMV", " V ", 'M', Hull_LuV, 'V', Conveyor_Module_LuV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_LV)}
                         );
        addCraftingRecipe(
                Automation_ItemDistributor_ZPM.get(1L), bitsd,
                new Object[]{"XCX", "VMV", " V ", 'M', Hull_ZPM, 'V', Conveyor_Module_ZPM, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_LV)}
                         );
        addCraftingRecipe(
                Automation_ItemDistributor_UV.get(1L), bitsd,
                new Object[]{"XCX", "VMV", " V ", 'M', Hull_UV, 'V', Conveyor_Module_UV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_LV)}
                         );
        addCraftingRecipe(
                Automation_ItemDistributor_MAX.get(1L), bitsd,
                new Object[]{"XCX", "VMV", " V ", 'M', Hull_MAX, 'V', Conveyor_Module_UHV, 'C', craftingChest, 'X', circuitLogic.get(LOGIC_LV)}
                         );
