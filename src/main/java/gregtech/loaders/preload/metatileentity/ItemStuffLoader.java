...
import static gregtech.api.enums.OrePrefixes.logiccircuit;
...
public final class ItemStuffLoader {
    ...
    public static void load() {
        ...
        addCraftingRecipe(Automation_ChestBuffer_ULV.get(1L), bitsd, new Object[]{"CMV", " X ", 'M', Hull_ULV, 'V', Conveyor_Module_LV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_ChestBuffer_LV.get(1L), bitsd, new Object[]{"CMV", " X ", 'M', Hull_LV, 'V', Conveyor_Module_LV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_ChestBuffer_MV.get(1L), bitsd, new Object[]{"CMV", " X ", 'M', Hull_MV, 'V', Conveyor_Module_MV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_MV)});
        addCraftingRecipe(Automation_ChestBuffer_HV.get(1L), bitsd, new Object[]{"CMV", " X ", 'M', Hull_HV, 'V', Conveyor_Module_HV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_HV)});
        addCraftingRecipe(Automation_ChestBuffer_EV.get(1L), bitsd, new Object[]{"CMV", " X ", 'M', Hull_EV, 'V', Conveyor_Module_EV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_EV)});
        addCraftingRecipe(Automation_ChestBuffer_IV.get(1L), bitsd, new Object[]{"CMV", " X ", 'M', Hull_IV, 'V', Conveyor_Module_IV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_IV)});
        addCraftingRecipe(Automation_ChestBuffer_LuV.get(1L), bitsd, new Object[]{"CMV", " X ", 'M', Hull_LuV, 'V', Conveyor_Module_LuV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_LUV)});
        addCraftingRecipe(Automation_ChestBuffer_ZPM.get(1L), bitsd, new Object[]{"CMV", " X ", 'M', Hull_ZPM, 'V', Conveyor_Module_ZPM, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_ZPM)});
        addCraftingRecipe(Automation_ChestBuffer_UV.get(1L), bitsd, new Object[]{"CMV", " X ", 'M', Hull_UV, 'V', Conveyor_Module_UV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_UV)});
        addCraftingRecipe(Automation_ChestBuffer_MAX.get(1L), bitsd, new Object[]{"CMV", " X ", 'M', Hull_MAX, 'V', Conveyor_Module_UHV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_UHV)});
        ...
        addCraftingRecipe(Automation_Filter_ULV.get(1L), bitsd, new Object[]{" F ", "CMV", " X ", 'M', Hull_ULV, 'V', Electric_Motor_LV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Filter_LV.get(1L), bitsd, new Object[]{" F ", "CMV", " X ", 'M', Hull_LV, 'V', Conveyor_Module_LV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Filter_MV.get(1L), bitsd, new Object[]{" F ", "CMV", " X ", 'M', Hull_MV, 'V', Conveyor_Module_MV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Filter_HV.get(1L), bitsd, new Object[]{" F ", "CMV", " X ", 'M', Hull_HV, 'V', Conveyor_Module_HV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Filter_EV.get(1L), bitsd, new Object[]{" F ", "CMV", " X ", 'M', Hull_EV, 'V', Conveyor_Module_EV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Filter_IV.get(1L), bitsd, new Object[]{" F ", "CMV", " X ", 'M', Hull_IV, 'V', Conveyor_Module_IV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Filter_LuV.get(1L), bitsd, new Object[]{" F ", "CMV", " X ", 'M', Hull_LuV, 'V', Conveyor_Module_LuV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Filter_ZPM.get(1L), bitsd, new Object[]{" F ", "CMV", " X ", 'M', Hull_ZPM, 'V', Conveyor_Module_ZPM, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Filter_UV.get(1L), bitsd, new Object[]{" F ", "CMV", " X ", 'M', Hull_UV, 'V', Conveyor_Module_UV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Filter_MAX.get(1L), bitsd, new Object[]{" F ", "CMV", " X ", 'M', Hull_MAX, 'V', Conveyor_Module_UHV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        ...
        addCraftingRecipe(Automation_TypeFilter_ULV.get(1L), bitsd, new Object[]{" F ", "VMC", " X ", 'M', Hull_ULV, 'V', Conveyor_Module_LV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_TypeFilter_LV.get(1L), bitsd, new Object[]{" F ", "VMC", " X ", 'M', Hull_LV, 'V', Conveyor_Module_LV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_TypeFilter_MV.get(1L), bitsd, new Object[]{" F ", "VMC", " X ", 'M', Hull_MV, 'V', Conveyor_Module_MV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_TypeFilter_HV.get(1L), bitsd, new Object[]{" F ", "VMC", " X ", 'M', Hull_HV, 'V', Conveyor_Module_HV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_TypeFilter_EV.get(1L), bitsd, new Object[]{" F ", "VMC", " X ", 'M', Hull_EV, 'V', Conveyor_Module_EV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_TypeFilter_IV.get(1L), bitsd, new Object[]{" F ", "VMC", " X ", 'M', Hull_IV, 'V', Conveyor_Module_IV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_TypeFilter_LuV.get(1L), bitsd, new Object[]{" F ", "VMC", " X ", 'M', Hull_LuV, 'V', Conveyor_Module_LuV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_TypeFilter_ZPM.get(1L), bitsd, new Object[]{" F ", "VMC", " X ", 'M', Hull_ZPM, 'V', Conveyor_Module_ZPM, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_TypeFilter_UV.get(1L), bitsd, new Object[]{" F ", "VMC", " X ", 'M', Hull_UV, 'V', Conveyor_Module_UV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_TypeFilter_MAX.get(1L), bitsd, new Object[]{" F ", "VMC", " X ", 'M', Hull_MAX, 'V', Conveyor_Module_UHV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        ...
        addCraftingRecipe(Automation_Regulator_ULV.get(1L), bitsd, new Object[]{"XFX", "VMV", "XCX", 'M', Hull_ULV, 'V', Robot_Arm_LV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Regulator_LV.get(1L), bitsd, new Object[]{"XFX", "VMV", "XCX", 'M', Hull_LV, 'V', Robot_Arm_LV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Regulator_MV.get(1L), bitsd, new Object[]{"XFX", "VMV", "XCX", 'M', Hull_MV, 'V', Robot_Arm_MV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Regulator_HV.get(1L), bitsd, new Object[]{"XFX", "VMV", "XCX", 'M', Hull_HV, 'V', Robot_Arm_HV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Regulator_EV.get(1L), bitsd, new Object[]{"XFX", "VMV", "XCX", 'M', Hull_EV, 'V', Robot_Arm_EV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Regulator_IV.get(1L), bitsd, new Object[]{"XFX", "VMV", "XCX", 'M', Hull_IV, 'V', Robot_Arm_IV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Regulator_LuV.get(1L), bitsd, new Object[]{"XFX", "VMV", "XCX", 'M', Hull_LuV, 'V', Robot_Arm_LuV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Regulator_ZPM.get(1L), bitsd, new Object[]{"XFX", "VMV", "XCX", 'M', Hull_ZPM, 'V', Robot_Arm_ZPM, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Regulator_UV.get(1L), bitsd, new Object[]{"XFX", "VMV", "XCX", 'M', Hull_UV, 'V', Robot_Arm_UV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_Regulator_MAX.get(1L), bitsd, new Object[]{"XFX", "VMV", "XCX", 'M', Hull_MAX, 'V', Robot_Arm_UHV, 'C', craftingChest, 'F', craftingFilter, 'X', logiccircuit.get(LOGIC_LV)});
        ...
        addCraftingRecipe(Automation_ItemDistributor_ULV.get(1L), bitsd, new Object[]{"XCX", "VMV", " V ", 'M', Hull_ULV, 'V', Conveyor_Module_LV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_ItemDistributor_LV.get(1L), bitsd, new Object[]{"XCX", "VMV", " V ", 'M', Hull_LV, 'V', Conveyor_Module_LV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_ItemDistributor_MV.get(1L), bitsd, new Object[]{"XCX", "VMV", " V ", 'M', Hull_MV, 'V', Conveyor_Module_MV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_ItemDistributor_HV.get(1L), bitsd, new Object[]{"XCX", "VMV", " V ", 'M', Hull_HV, 'V', Conveyor_Module_HV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_ItemDistributor_EV.get(1L), bitsd, new Object[]{"XCX", "VMV", " V ", 'M', Hull_EV, 'V', Conveyor_Module_EV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_ItemDistributor_IV.get(1L), bitsd, new Object[]{"XCX", "VMV", " V ", 'M', Hull_IV, 'V', Conveyor_Module_IV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_ItemDistributor_LuV.get(1L), bitsd, new Object[]{"XCX", "VMV", " V ", 'M', Hull_LuV, 'V', Conveyor_Module_LuV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_ItemDistributor_ZPM.get(1L), bitsd, new Object[]{"XCX", "VMV", " V ", 'M', Hull_ZPM, 'V', Conveyor_Module_ZPM, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_ItemDistributor_UV.get(1L), bitsd, new Object[]{"XCX", "VMV", " V ", 'M', Hull_UV, 'V', Conveyor_Module_UV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_LV)});
        addCraftingRecipe(Automation_ItemDistributor_MAX.get(1L), bitsd, new Object[]{"XCX", "VMV", " V ", 'M', Hull_MAX, 'V', Conveyor_Module_UHV, 'C', craftingChest, 'X', logiccircuit.get(LOGIC_LV)});
