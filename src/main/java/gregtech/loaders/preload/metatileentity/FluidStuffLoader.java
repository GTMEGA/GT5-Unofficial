...
public final class FluidStuffLoader {
    ...
    public static void load() {
        ...
        addCraftingRecipe(Pump_LV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CPC", "PMP", "BPB", 'M', Hull_LV, 'B', pipeLarge.get(Brass), 'C', circuitPower.get(PWR_LV), 'P', Electric_Pump_LV});
        addCraftingRecipe(Pump_MV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CPC", "PMP", "BPB", 'M', Hull_MV, 'B', pipeLarge.get(Steel), 'C', circuitPower.get(PWR_MV), 'P', Electric_Pump_MV});
        addCraftingRecipe(Pump_HV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CPC", "PMP", "BPB", 'M', Hull_HV, 'B', pipeLarge.get(StainlessSteel), 'C', circuitPower.get(PWR_HV), 'P', Electric_Pump_HV});
        addCraftingRecipe(Pump_EV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CPC", "PMP", "BPB", 'M', Hull_EV, 'B', pipeLarge.get(Titanium), 'C', circuitPower.get(PWR_EV), 'P', Electric_Pump_EV});
        addCraftingRecipe(Pump_IV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CPC", "PMP", "BPB", 'M', Hull_IV, 'B', pipeLarge.get(TungstenSteel), 'C', circuitPower.get(PWR_IV), 'P', Electric_Pump_IV});
        LOADED = true;
    }
}
