...
//        addCraftingRecipe(Battery_Buffer_3by3_MAX.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", 'M', Hull_MAX, 'W', wireGt08.get(SuperconductorUHV), 'T', craftingChest});
        ...
        Battery_Buffer_4by4_ULV.set(new GT_MetaTileEntity_BasicBatteryBuffer(190, "batterybuffer.16.tier.00", "ULV Battery Buffer (Deprecated)", 0, "", 16).getStackForm(1L));
        Battery_Buffer_4by4_LV.set(new GT_MetaTileEntity_BasicBatteryBuffer(191, "batterybuffer.16.tier.01", "LV Battery Buffer (Deprecated)", 1, "", 16).getStackForm(1L));
        Battery_Buffer_4by4_MV.set(new GT_MetaTileEntity_BasicBatteryBuffer(192, "batterybuffer.16.tier.02", "MV Battery Buffer (Deprecated)", 2, "", 16).getStackForm(1L));
        Battery_Buffer_4by4_HV.set(new GT_MetaTileEntity_BasicBatteryBuffer(193, "batterybuffer.16.tier.03", "HV Battery Buffer (Deprecated)", 3, "", 16).getStackForm(1L));
        Battery_Buffer_4by4_EV.set(new GT_MetaTileEntity_BasicBatteryBuffer(194, "batterybuffer.16.tier.04", "EV Battery Buffer (Deprecated)", 4, "", 16).getStackForm(1L));
        Battery_Buffer_4by4_IV.set(new GT_MetaTileEntity_BasicBatteryBuffer(195, "batterybuffer.16.tier.05", "IV Battery Buffer (Deprecated)", 5, "", 16).getStackForm(1L));
        Battery_Buffer_4by4_LuV.set(new GT_MetaTileEntity_BasicBatteryBuffer(196, "batterybuffer.16.tier.06", "LuV Battery Buffer (Deprecated)", 6, "", 16).getStackForm(1L));
        Battery_Buffer_4by4_ZPM.set(new GT_MetaTileEntity_BasicBatteryBuffer(197, "batterybuffer.16.tier.07", "ZPM Battery Buffer (Deprecated)", 7, "", 16).getStackForm(1L));
        Battery_Buffer_4by4_UV.set(new GT_MetaTileEntity_BasicBatteryBuffer(198, "batterybuffer.16.tier.08", "UV Battery Buffer (Deprecated)", 8, "", 16).getStackForm(1L));
        Battery_Buffer_4by4_MAX.set(new GT_MetaTileEntity_BasicBatteryBuffer(199, "batterybuffer.16.tier.09", "UHV Battery Buffer (Deprecated)", 9, "", 16).getStackForm(1L));
...
//        addCraftingRecipe(Battery_Buffer_4by4_MAX.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", 'M', Hull_MAX, 'W', wireGt08.get(SuperconductorUHV), 'T', craftingChest});
        ...
        Battery_Charger_4by4_ULV.set(new GT_MetaTileEntity_Charger(690, "batterycharger.16.tier.00", "ULV Battery Buffer", 0, "Each battery gives 8A in/4A out (min 4A/2A)", 16).getStackForm(1L));
        Battery_Charger_4by4_LV.set(new GT_MetaTileEntity_Charger(691, "batterycharger.16.tier.01", "LV Battery Buffer", 1, "Each battery gives 8A in/4A out (min 4A/2A)", 16).getStackForm(1L));
        Battery_Charger_4by4_MV.set(new GT_MetaTileEntity_Charger(692, "batterycharger.16.tier.02", "MV Battery Buffer", 2, "Each battery gives 8A in/4A out (min 4A/2A)", 16).getStackForm(1L));
        Battery_Charger_4by4_HV.set(new GT_MetaTileEntity_Charger(693, "batterycharger.16.tier.03", "HV Battery Buffer", 3, "Each battery gives 8A in/4A out (min 4A/2A)", 16).getStackForm(1L));
        Battery_Charger_4by4_EV.set(new GT_MetaTileEntity_Charger(694, "batterycharger.16.tier.04", "EV Battery Buffer", 4, "Each battery gives 8A in/4A out (min 4A/2A)", 16).getStackForm(1L));
        Battery_Charger_4by4_IV.set(new GT_MetaTileEntity_Charger(695, "batterycharger.16.tier.05", "IV Battery Buffer", 5, "Each battery gives 8A in/4A out (min 4A/2A)", 4).getStackForm(1L));
        Battery_Charger_4by4_LuV.set(new GT_MetaTileEntity_Charger(696, "batterycharger.16.tier.06", "LuV Battery Buffer", 6, "Each battery gives 8A in/4A out (min 4A/2A)", 4).getStackForm(1L));
        Battery_Charger_4by4_ZPM.set(new GT_MetaTileEntity_Charger(697, "batterycharger.16.tier.07", "ZPM Battery Buffer", 7, "Each battery gives 8A in/4A out (min 4A/2A)", 4).getStackForm(1L));
        Battery_Charger_4by4_UV.set(new GT_MetaTileEntity_Charger(698, "batterycharger.16.tier.08", "UV Battery Buffer", 8, "Each battery gives 8A in/4A out (min 4A/2A)", 4).getStackForm(1L));
        Battery_Charger_4by4_MAX.set(new GT_MetaTileEntity_Charger(699, "batterycharger.16.tier.09", "UHV Battery Buffer", 9, "Each battery gives 8A in/4A out (min 4A/2A)", 4).getStackForm(1L));
        addCraftingRecipe(Battery_Charger_4by4_ULV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", 'M', Hull_ULV, 'W', cableGt08.get(Tin), 'T', circuitPower.get(PWR_LV)});
        addCraftingRecipe(Battery_Charger_4by4_LV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", 'M', Hull_LV, 'W', cableGt08.get(Tin), 'T',circuitPower.get(PWR_LV)});
        addCraftingRecipe(Battery_Charger_4by4_MV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", 'M', Hull_MV, 'W', cableGt08.get(AnyCopper), 'T', circuitPower.get(PWR_MV)});
        addCraftingRecipe(Battery_Charger_4by4_HV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", 'M', Hull_HV, 'W', cableGt08.get(Gold), 'T', circuitPower.get(PWR_HV)});
        addCraftingRecipe(Battery_Charger_4by4_EV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", 'M', Hull_HV, 'W', cableGt08.get(Aluminium), 'T', circuitPower.get(PWR_EV)});
        ...
        addCraftingRecipe(Locker_ULV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"T", "M", 'M', Battery_Charger_4by4_ULV, 'T', craftingChest});
        addCraftingRecipe(Locker_LV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"T", "M", 'M', Battery_Charger_4by4_LV, 'T', craftingChest});
        addCraftingRecipe(Locker_MV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"T", "M", 'M', Battery_Charger_4by4_MV, 'T', craftingChest});
        addCraftingRecipe(Locker_HV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"T", "M", 'M', Battery_Charger_4by4_HV, 'T', craftingChest});
        addCraftingRecipe(Locker_EV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"T", "M", 'M', Battery_Charger_4by4_EV, 'T', craftingChest});
