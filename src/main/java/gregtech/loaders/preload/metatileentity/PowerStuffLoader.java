...
public final class PowerStuffLoader {
    ...
    public static void load() {
        ...
        addCraftingRecipe(Transformer_HV_MV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"KBB", "CM ", "KBB", 'M', Hull_MV, 'C', cableGt01.get(Gold), 'B', cableGt01.get(AnyCopper), 'K', pwrcircuit.get(PWR_LV)});
        addCraftingRecipe(Transformer_EV_HV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"KBB", "CM ", "KBB", 'M', Hull_HV, 'C', cableGt01.get(Aluminium), 'B', cableGt01.get(Gold), 'K', pwrcircuit.get(PWR_MV)});
        addCraftingRecipe(Transformer_IV_EV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"KBB", "CM ", "KBB", 'M', Hull_EV, 'C', cableGt01.get(Tungsten), 'B', cableGt01.get(Aluminium), 'K', pwrcircuit.get(PWR_HV)});
        addCraftingRecipe(Transformer_LuV_IV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"KBB", "CM ", "KBB", 'M', Hull_IV, 'C', cableGt01.get(VanadiumGallium), 'B', cableGt01.get(Tungsten), 'K', pwrcircuit.get(PWR_EV)});
        addCraftingRecipe(Transformer_ZPM_LuV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"KBB", "CM ", "KBB", 'M', Hull_LuV, 'C', cableGt01.get(Naquadah), 'B', cableGt01.get(VanadiumGallium), 'K', pwrcircuit.get(PWR_IV)});
        addCraftingRecipe(Transformer_UV_ZPM.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"KBB", "CM ", "KBB", 'M', Hull_ZPM, 'C', cableGt01.get(NaquadahAlloy), 'B', cableGt01.get(Naquadah), 'K', pwrcircuit.get(PWR_LUV)});
        addCraftingRecipe(Transformer_MAX_UV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"KBB", "CM ", "KBB", 'M', Hull_UV, 'C', wireGt01.get(Bedrockium), 'B', cableGt01.get(NaquadahAlloy), 'K', pwrcircuit.get(PWR_ZPM)});
        ...
        addCraftingRecipe(Battery_Charger_4by4_ULV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", "BCB", 'M', Hull_ULV, 'W', wireGt16.get(RedAlloy), 'T', craftingChest, 'B', Battery_RE_HV_Sodium, 'C', pwrcircuit.get(PWR_LV)});
        addCraftingRecipe(Battery_Charger_4by4_LV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", "BCB", 'M', Hull_LV, 'W', wireGt16.get(Tin), 'T', craftingChest, 'B', Battery_RE_LV_Lithium, 'C', pwrcircuit.get(PWR_LV)});
        addCraftingRecipe(Battery_Charger_4by4_MV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", "BCB", 'M', Hull_MV, 'W', wireGt16.get(AnyCopper), 'T', craftingChest, 'B', Battery_RE_MV_Lithium, 'C', pwrcircuit.get(PWR_MV)});
        addCraftingRecipe(Battery_Charger_4by4_HV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", "BCB", 'M', Hull_HV, 'W', wireGt16.get(Gold), 'T', craftingChest, 'B', Battery_RE_HV_Lithium, 'C', pwrcircuit.get(PWR_HV)});
        addCraftingRecipe(Battery_Charger_4by4_EV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", "BCB", 'M', Hull_EV, 'W', wireGt16.get(Aluminium), 'T', craftingChest, 'B', battery.get(Master), 'C',pwrcircuit.get(PWR_EV)});
        addCraftingRecipe(Battery_Charger_4by4_IV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", "BCB", 'M', Hull_IV, 'W', wireGt16.get(Tungsten), 'T', craftingChest, 'B', Energy_LapotronicOrb, 'C', pwrcircuit.get(PWR_IV)});
        addCraftingRecipe(Battery_Charger_4by4_LuV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", "BCB", 'M', Hull_LuV, 'W', wireGt16.get(VanadiumGallium), 'T', craftingChest, 'B', Energy_LapotronicOrb2, 'C',pwrcircuit.get(PWR_LUV)});
        addCraftingRecipe(Battery_Charger_4by4_ZPM.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", "BCB", 'M', Hull_ZPM, 'W', wireGt16.get(Naquadah), 'T', craftingChest, 'B', Energy_LapotronicOrb2, 'C', pwrcircuit.get(PWR_ZPM)});
        addCraftingRecipe(Battery_Charger_4by4_UV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", "BCB", 'M', Hull_UV, 'W', wireGt16.get(NaquadahAlloy), 'T', craftingChest, 'B', ZPM2, 'C', pwrcircuit.get(PWR_UV)});
        addCraftingRecipe(Battery_Charger_4by4_MAX.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WTW", "WMW", "BCB", 'M', Hull_MAX, 'W', wireGt16.get(SuperconductorUHV), 'T', craftingChest, 'B', ZPM2, 'C', pwrcircuit.get(PWR_UHV)});
        ...
        addCraftingRecipe(MicroTransmitter_HV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CPC", "CMC", "GBG", 'M', Hull_HV, 'B', Battery_RE_HV_Lithium, 'C', Emitter_HV, 'G', pwrcircuit.get(PWR_HV), 'P', Field_Generator_HV});
        addCraftingRecipe(MicroTransmitter_EV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CPC", "CMC", "GBG", 'M', Hull_EV, 'B', getIC2Item("lapotronCrystal", 1L, GT_Values.W), 'C', Emitter_EV, 'G', pwrcircuit.get(PWR_EV), 'P', Field_Generator_EV});
        addCraftingRecipe(MicroTransmitter_IV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CPC", "CMC", "GBG", 'M', Hull_IV, 'B', Energy_LapotronicOrb, 'C', Emitter_IV, 'G', pwrcircuit.get(PWR_IV), 'P', Field_Generator_IV});
        addCraftingRecipe(MicroTransmitter_LUV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CPC", "CMC", "GBG", 'M', Hull_LuV, 'B', Energy_LapotronicOrb2, 'C', Emitter_LuV, 'G', pwrcircuit.get(PWR_LUV), 'P', Field_Generator_LuV});
        addCraftingRecipe(MicroTransmitter_ZPM.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CPC", "CMC", "GBG", 'M', Hull_ZPM, 'B', sOPStuff.get(gregtechrecipes, "EnableZPMandUVBatteries", false) ? Energy_Module : ZPM2, 'C', Emitter_ZPM, 'G', pwrcircuit.get(PWR_ZPM), 'P', Field_Generator_ZPM});
        addCraftingRecipe(MicroTransmitter_UV.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CPC", "CMC", "GBG", 'M', Hull_UV, 'B', sOPStuff.get(gregtechrecipes, "EnableZPMandUVBatteries", false) ? Energy_Module : ZPM3, 'C', Emitter_UV, 'G', pwrcircuit.get(PWR_UV), 'P', Field_Generator_UV});
