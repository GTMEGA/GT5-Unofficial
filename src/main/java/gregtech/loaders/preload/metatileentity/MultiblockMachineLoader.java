...
public final class MultiblockMachineLoader {
    ...
    public static void load() {
        ...
        addCraftingRecipe(Machine_Multi_BlastFurnace.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"FFF", "YMY", "WCW", 'M', Casing_HeatProof, 'F', craftingIronFurnace, 'C', logiccircuit.get(LOGIC_LV), 'Y', pwrcircuit.get(PWR_LV), 'W', cableGt01.get(Tin)});
        addCraftingRecipe(Machine_Multi_VacuumFreezer.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"PPP", "CMC", "WCW", 'M', Casing_FrostProof, 'P', Electric_Pump_HV, 'C', pwrcircuit.get(PWR_EV), 'W', cableGt01.get(Gold)});
        addCraftingRecipe(Machine_Multi_ImplosionCompressor.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"OOO", "CMC", "WCW", 'M', Casing_SolidSteel, 'O', reinforcedStone, 'C', logiccircuit.get(LOGIC_HV), 'W', cableGt01.get(Gold)});
        addCraftingRecipe(Machine_Multi_Furnace.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"FFF", "CMC", "WCW", 'M', Casing_HeatProof, 'F', craftingIronFurnace, 'C', pwrcircuit.get(PWR_MV), 'W', cableGt01.get(AnnealedCopper)});
        ...
        addCraftingRecipe(Machine_Multi_LargeBoiler_Bronze.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WCW", "CMC", "WCW", 'M', Casing_Firebox_Bronze, 'C',pwrcircuit.get(PWR_MV), 'W', cableGt01.get(Tin)});
        addCraftingRecipe(Machine_Multi_LargeBoiler_Steel.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WCW", "CMC", "WCW", 'M', Casing_Firebox_Steel, 'C', pwrcircuit.get(PWR_HV), 'W', cableGt01.get(AnyCopper)});
        addCraftingRecipe(Machine_Multi_LargeBoiler_Titanium.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WCW", "CMC", "WCW", 'M', Casing_Firebox_Titanium, 'C', pwrcircuit.get(PWR_EV), 'W', cableGt01.get(Gold)});
        addCraftingRecipe(Machine_Multi_LargeBoiler_TungstenSteel.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WCW", "CMC", "WCW", 'M', Casing_Firebox_TungstenSteel, 'C', pwrcircuit.get(PWR_IV), 'W', cableGt01.get(Aluminium)});
        ...
        addCraftingRecipe(Casing_Fusion_Coil.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CTC", "FMF", "CTC", 'M', Casing_Coil_Superconductor, 'C', pwrcircuit.get(PWR_LUV), 'F', Field_Generator_MV, 'T', Neutron_Reflector});
        ...
        addCraftingRecipe(Processing_Array.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CTC", "FMF", "CBC", 'M', Hull_EV, 'B', pipeLarge.get(StainlessSteel), 'C', logiccircuit.get(LOGIC_HV), 'F', Robot_Arm_EV, 'T', IC2_LapotronCrystal});
        ...
        addCraftingRecipe(Distillation_Tower.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CBC", "FMF", "CBC", 'M', Hull_HV, 'B', pipeLarge.get(StainlessSteel), 'C', pwrcircuit.get(PWR_HV), 'F', Electric_Pump_HV});
        ...
        addCraftingRecipe(LargeSteamTurbine.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CPC", "PMP", "BPB", 'M', Hull_HV, 'B', pipeLarge.get(Steel), 'C', pwrcircuit.get(PWR_MV), 'P', gearGt.get(Steel)});
        addCraftingRecipe(LargeGasTurbine.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CPC", "PMP", "BPB", 'M', Hull_EV, 'B', pipeLarge.get(StainlessSteel), 'C', logiccircuit.get(LOGIC_EV), 'P', gearGt.get(StainlessSteel)});
        ...
        addCraftingRecipe(ConcreteBackfiller1.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WPW", "EME", "CQC", 'M', Hull_LV, 'W', frameGt.get(Steel), 'E', logiccircuit.get(LOGIC_LV), 'C', Electric_Motor_LV, 'P', pipeLarge.get(Steel), 'Q', Electric_Pump_LV});
        addCraftingRecipe(ConcreteBackfiller2.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WPW", "EME", "CQC", 'M', ConcreteBackfiller1, 'W', frameGt.get(StainlessSteel), 'E', logiccircuit.get(LOGIC_HV), 'C', Electric_Motor_HV, 'P', pipeLarge.get(StainlessSteel), 'Q', Electric_Pump_HV});
        ...
        addCraftingRecipe(PyrolyseOven.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WEP", "EME", "WCP", 'M', Hull_LV, 'W', Electric_Piston_LV, 'P', wireGt04.get(Cupronickel), 'E', pwrcircuit.get(PWR_LV), 'C', Electric_Pump_LV});

        OilCracker.set(new GT_MetaTileEntity_OilCracker(1160, "multimachine.cracker", "Oil Cracking Unit").getStackForm(1));
        addCraftingRecipe(OilCracker.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WCW", "EME", "WCW", 'M', Hull_HV, 'W', Casing_Coil_Cupronickel, 'E', pwrcircuit.get(PWR_HV), 'C', Electric_Pump_HV});
        ...
        addCraftingRecipe(Machine_Multi_Assemblyline.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"WCW", "EME", "WCW", 'M', Hull_IV, 'W', Casing_Assembler, 'E', logiccircuit.get(LOGIC_IV), 'C', Robot_Arm_IV});
        ...
        if (gregtechproxy.mEnableCleanroom) {
            addCraftingRecipe(Machine_Multi_Cleanroom.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"FFF", "RHR", "MCM", 'H', Hull_HV, 'F', Component_Filter, 'R', rotor.get(StainlessSteel), 'M', Electric_Motor_HV, 'C', logiccircuit.get(LOGIC_HV)});
        } else {
