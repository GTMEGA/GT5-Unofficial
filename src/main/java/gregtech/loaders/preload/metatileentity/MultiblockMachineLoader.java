...
public final class MultiblockMachineLoader {
    ...
    public static void load() {
        ...
        addCraftingRecipe(Processing_Array.get(1L), DISMANTLEABLE_RECIPE_MASK, new Object[]{"CTC", "FMF", "CBC", 'M', Hull_MV, 'B', pipeLarge.get(StainlessSteel), 'C', circuitLogic.get(LOGIC_MV), 'F', Robot_Arm_MV, 'T', Pump_MV});
