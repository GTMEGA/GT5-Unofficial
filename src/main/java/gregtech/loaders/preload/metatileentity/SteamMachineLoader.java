...
public final class SteamMachineLoader {
    ...
    public static void load() {
        ...
        addCraftingRecipe(Machine_Bronze_Boiler_Solar.get(1L), RECIPE_MASK, new Object[]{"GGG", "SSS", "PMP", 'M', Hull_Bronze_Bricks, 'P', pipeSmall.get(Brass), 'S', plateDouble.get(Silver), 'G', new ItemStack(Blocks.glass, 1)});
