...
public final class SteamMachineLoader {
    ...
    public static void load() {
        ...
        addCraftingRecipe(
                Machine_Bronze_Boiler.get(1L), RECIPE_MASK,
                new Object[]{"PPP", "PwP", "BFB", 'F', craftingIronFurnace, 'P', plate.get(Brass), 'B', new ItemStack(Blocks.brick_block, 1)}
                         );
        addCraftingRecipe(
                Machine_Steel_Boiler.get(1L), RECIPE_MASK,
                new Object[]{"PPP", "PwP", "BFB", 'F', craftingIronFurnace, 'P', plate.get(Steel), 'B', new ItemStack(Blocks.brick_block, 1)}
                         );
        addCraftingRecipe(
                Machine_Steel_Boiler_Lava.get(1L), RECIPE_MASK,
                new Object[]{"PPP", "PTP", "PMP", 'M', Hull_HP, 'P', plate.get(Steel), 'T', getModItem("BuildCraft|Factory", "tankBlock", 1L, 0)}
                         );
        addCraftingRecipe(
                Machine_Bronze_Boiler_Solar.get(1L), RECIPE_MASK, new Object[]{
                        "GGG", "SSS", "PMP", 'M', Hull_Bronze_Bricks, 'P', pipeSmall.get(Brass), 'S', plateDouble.get(Silver), 'G',
                        new ItemStack(Blocks.glass, 1)
                });
        addCraftingRecipe(
                Machine_HP_Solar.get(1L), RECIPE_MASK, new Object[]{
                        "GGG", "SSS", "PMP", 'M', Hull_HP_Bricks, 'P', pipeSmall.get(Steel), 'S', plateTriple.get(Silver), 'G',
                        getModItem("IC2", "blockAlloyGlass", 1L)
                });

        Machine_Bronze_BlastFurnace.set(
                new GT_MetaTileEntity_BronzeBlastFurnace(108, "bronzemachine.blastfurnace", "Brass Plated Blast Furnace").getStackForm(1L));
        ...
        Machine_HP_Sifter.set(
                new GT_MetaTileEntity_Sifter_Steel(9330, "hpmachine.sifter", "High Pressure Sifter", "Stay calm and keep sifting.").getStackForm(1L));
        ...
        addCraftingRecipe(
                Machine_Bronze_Furnace.get(1L), RECIPE_MASK,
                new Object[]{"XXX", "XMX", "XFX", 'M', Hull_Bronze_Bricks, 'X', pipeSmall.get(Brass), 'F', craftingFurnace}
                         );
        addCraftingRecipe(
                Machine_HP_Furnace.get(1L), RECIPE_MASK, new Object[]{
                        "XSX", "PMP", "XXX", 'M', Machine_Bronze_Furnace, 'X', pipeSmall.get(WroughtIron), 'P', plate.get(WroughtIron), 'S', plate.get(Steel)
                });
        addCraftingRecipe(
                Machine_Bronze_Macerator.get(1L), RECIPE_MASK,
                new Object[]{"DXD", "XMX", "PXP", 'M', Hull_Bronze, 'X', pipeSmall.get(Brass), 'P', craftingPiston, 'D', gem.get(Diamond)}
                         );
        addCraftingRecipe(
                Machine_HP_Macerator.get(1L), RECIPE_MASK, new Object[]{
                        "PSP", "XMX", "PPP", 'M', Machine_Bronze_Macerator, 'X', pipeSmall.get(WroughtIron), 'P', plate.get(WroughtIron), 'S', plate.get(Steel)
                });
        addCraftingRecipe(
                Machine_Bronze_Extractor.get(1L), RECIPE_MASK, new Object[]{
                        "XXX", "PMG", "XXX", 'M', Hull_Bronze, 'X', pipeSmall.get(Brass), 'P', craftingPiston, 'G', new ItemStack(Blocks.glass, 1)
                });
        addCraftingRecipe(
                Machine_HP_Extractor.get(1L), RECIPE_MASK, new Object[]{
                        "XSX", "PMP", "XXX", 'M', Machine_Bronze_Extractor, 'X', pipeSmall.get(WroughtIron), 'P', plate.get(WroughtIron), 'S', plate.get(Steel)
                });
        addCraftingRecipe(
                Machine_Bronze_Hammer.get(1L), RECIPE_MASK,
                new Object[]{"XPX", "XMX", "XAX", 'M', Hull_Bronze, 'X', pipeSmall.get(Brass), 'P', craftingPiston, 'A', craftingAnvil}
                         );
        addCraftingRecipe(
                Machine_HP_Hammer.get(1L), RECIPE_MASK, new Object[]{
                        "PSP", "XMX", "PPP", 'M', Machine_Bronze_Hammer, 'X', pipeSmall.get(WroughtIron), 'P', plate.get(WroughtIron), 'S', plate.get(Steel)
                });
        addCraftingRecipe(
                Machine_Bronze_Compressor.get(1L), RECIPE_MASK,
                new Object[]{"XXX", "PMP", "XXX", 'M', Hull_Bronze, 'X', pipeSmall.get(Brass), 'P', craftingPiston}
                         );
        addCraftingRecipe(
                Machine_HP_Compressor.get(1L), RECIPE_MASK, new Object[]{
                        "XSX", "PMP", "XXX", 'M', Machine_Bronze_Compressor, 'X', pipeSmall.get(WroughtIron), 'P', plate.get(WroughtIron), 'S', plate.get(Steel)
                });
        addCraftingRecipe(
                Machine_Bronze_AlloySmelter.get(1L), RECIPE_MASK,
                new Object[]{"XXX", "FMF", "XXX", 'M', Hull_Bronze_Bricks, 'X', pipeSmall.get(Brass), 'F', craftingFurnace}
                         );
        addCraftingRecipe(
                Machine_HP_AlloySmelter.get(1L), RECIPE_MASK, new Object[]{
                        "PSP", "PMP", "PXP", 'M', Machine_Bronze_AlloySmelter, 'X', pipeSmall.get(WroughtIron), 'P', plate.get(WroughtIron), 'S',
                        plate.get(Steel)
                });
        LOADED = true;
    }
