...
public final class CasingRecipeLoader {
    ...
    public static void load() {
        ...
        addCraftingRecipe(
                Casing_Pipe_Polytetrafluoroethylene.getOne(), RECIPE_MASK, new Object[]{
                        "PIP", "IFI", "PIP", 'P', plate.get(Polytetrafluoroethylene), 'F', frameGt.get(Polytetrafluoroethylene), 'I',
                        pipeMedium.get(Polytetrafluoroethylene)
                });
        addCraftingRecipe(
                Casing_BronzePlatedBricks.getOne(), RECIPE_MASK, new Object[]{"PhP", "PBP", "PwP", 'P', plate.get(Bronze), 'B', new ItemStack(brick_block, 1)});
        ...
        addCraftingRecipe(
                Casing_CleanStainlessSteel.getOne(), RECIPE_MASK,
                new Object[]{"PhP", "PFP", "PwP", 'P', plate.get(StainlessSteel), 'F', frameGt.get(StainlessSteel)}
                         );
        addCraftingRecipe(
                Casing_RobustTungstenSteel.getOne(), RECIPE_MASK,
                new Object[]{"PhP", "PFP", "PwP", 'P', plate.get(TungstenSteel), 'F', frameGt.get(TungstenSteel)}
                         );
        addCraftingRecipe(
                Casing_MiningOsmiridium.getOne(), RECIPE_MASK, new Object[]{"PhP", "PFP", "PwP", 'P', plate.get(Osmiridium), 'F', frameGt.get(Osmiridium)});
        addCraftingRecipe(
                Casing_MiningNeutronium.getOne(), RECIPE_MASK, new Object[]{"PhP", "PFP", "PwP", 'P', plate.get(Neutronium), 'F', frameGt.get(Neutronium)});
        addCraftingRecipe(
                Casing_MiningBlackPlutonium.getOne(), RECIPE_MASK,
                new Object[]{"PhP", "PFP", "PwP", 'P', plate.get(BlackPlutonium), 'F', frameGt.get(BlackPlutonium)}
                         );
        ...
        addCraftingRecipe(
                Casing_Pipe_Bronze.getOne(), RECIPE_MASK,
                new Object[]{"PIP", "IFI", "PIP", 'P', plate.get(Bronze), 'F', frameGt.get(Bronze), 'I', pipeMedium.get(Bronze)}
                         );
        addCraftingRecipe(
                Casing_Pipe_Steel.getOne(), RECIPE_MASK,
                new Object[]{"PIP", "IFI", "PIP", 'P', plate.get(Steel), 'F', frameGt.get(Steel), 'I', pipeMedium.get(Steel)}
                         );
        addCraftingRecipe(
                Casing_Pipe_Titanium.getOne(), RECIPE_MASK,
                new Object[]{"PIP", "IFI", "PIP", 'P', plate.get(Titanium), 'F', frameGt.get(Titanium), 'I', pipeMedium.get(Titanium)}
                         );
        addCraftingRecipe(
                Casing_Pipe_TungstenSteel.getOne(), RECIPE_MASK,
                new Object[]{"PIP", "IFI", "PIP", 'P', plate.get(TungstenSteel), 'F', frameGt.get(TungstenSteel), 'I', pipeMedium.get(TungstenSteel)}
                         );
        addCraftingRecipe(
                Casing_Gearbox_Bronze.getOne(), RECIPE_MASK,
                new Object[]{"PhP", "GFG", "PwP", 'P', plate.get(Bronze), 'F', frameGt.get(Bronze), 'G', gearGt.get(Bronze)}
                         );
        addCraftingRecipe(
                Casing_Gearbox_Steel.getOne(), RECIPE_MASK,
                new Object[]{"PhP", "GFG", "PwP", 'P', plate.get(Steel), 'F', frameGt.get(Steel), 'G', gearGt.get(Steel)}
                         );
        addCraftingRecipe(
                Casing_Gearbox_Titanium.getOne(), RECIPE_MASK,
                new Object[]{"PhP", "GFG", "PwP", 'P', plate.get(Steel), 'F', frameGt.get(Titanium), 'G', gearGt.get(Titanium)}
                         );
        addCraftingRecipe(
                Casing_Gearbox_TungstenSteel.getOne(), RECIPE_MASK,
                new Object[]{"PhP", "GFG", "PwP", 'P', plate.get(Steel), 'F', frameGt.get(TungstenSteel), 'G', Robot_Arm_IV}
                         );
        addCraftingRecipe(
                Casing_Grate.getOne(), RECIPE_MASK, new Object[]{
                        "PVP", "PFP", "PMP", 'P', new ItemStack(iron_bars, 1), 'F', frameGt.get(Steel), 'M', Electric_Motor_MV, 'V', rotor.get(Steel)
                });
        addCraftingRecipe(
                Casing_Assembler.getOne(), RECIPE_MASK, new Object[]{
                        "PVP", "PFP", "PMP", 'P', circuitLogic.get(LOGIC_IV), 'F', frameGt.get(TungstenSteel), 'M', Electric_Motor_IV, 'V',
                        circuitPower.get(PWR_LUV)
                });
        addCraftingRecipe(
                Casing_Firebox_Bronze.getOne(), RECIPE_MASK,
                new Object[]{"PSP", "SFS", "PSP", 'P', plate.get(Bronze), 'F', frameGt.get(Bronze), 'S', stick.get(Bronze)}
                         );
        addCraftingRecipe(
                Casing_Firebox_Steel.getOne(), RECIPE_MASK,
                new Object[]{"PSP", "SFS", "PSP", 'P', plate.get(Steel), 'F', frameGt.get(Steel), 'S', stick.get(Steel)}
                         );
        addCraftingRecipe(
                Casing_Firebox_Titanium.getOne(), RECIPE_MASK,
                new Object[]{"PSP", "SFS", "PSP", 'P', plate.get(Titanium), 'F', frameGt.get(Titanium), 'S', stick.get(Titanium)}
                         );
        addCraftingRecipe(
                Casing_Firebox_TungstenSteel.getOne(), RECIPE_MASK,
                new Object[]{"PSP", "SFS", "PSP", 'P', plate.get(TungstenSteel), 'F', frameGt.get(TungstenSteel), 'S', stick.get(TungstenSteel)}
                         );
        ...
        addCraftingRecipe(
                Casing_RadioactiveHazard.getOne(), RECIPE_MASK, new Object[]{" YB", " M ", "   ", 'M', Casing_SolidSteel, 'Y', dyeYellow, 'B', dyeBlack});
        addCraftingRecipe(Casing_BioHazard.getOne(), RECIPE_MASK, new Object[]{" Y ", " MB", "   ", 'M', Casing_SolidSteel, 'Y', dyeYellow, 'B', dyeBlack});
        addCraftingRecipe(
                Casing_ExplosionHazard.getOne(), RECIPE_MASK, new Object[]{" Y ", " M ", "  B", 'M', Casing_SolidSteel, 'Y', dyeYellow, 'B', dyeBlack});
