...
public class GT_Loader_Item_Block_And_Fluid implements Runnable {
    ...
    public void run() {
        ...
        GT_Utility.getWrittenBook("Manual_Printer", "Printer Manual V2.0", "Gregorius Techneticies", new String[]{
                ...
                "1. Coloring Items and Blocks: You know those Crafting Recipes, which have a dye surrounded by 8 Item to dye them? Or the ones which have just one Item and one Dye in the Grid? Those two Recipe Types can be cheaply
                automated using the Printer.",
                ...
                "You got a stack of Pages for your new Book, just put them into the Assembler with some Glue and a piece of Leather for the Binding, and you receive an identical copy of the Book, which would stack together with the
                original.",
                "3. Renaming Items: This Functionality is no longer Part of the Printer. There is now a Name Mold for the Forming Press to imprint a Name into an Item, just rename the Mold in an Anvil and use it in the Forming Press on
                any Item.",
        ...
        GT_Utility.getWrittenBook("Manual_Punch_Cards", "Punch Card Manual V0.0", "Gregorius Techneticies", new String[]{
                ...
                "(i1&&i2)?o1=15:o1=0;=10", "ignore all Whitespace Characters, use Long for saving the Numbers", "&& || ^^ & | ^ ! ++ -- + - % / // * ** << >> >>> < > <= >= == !=  ~ ( ) ?: , ; ;= ;=X; = i0 i1 i2 i3 i4 i5 o0 o1 o2 o3 o4 o5
                 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 m0 m1 m2 m3 m4 m5 m6 m7 m8 m9 A B C D E F",
                ...
                "If the '=' Operator is used within Brackets, it returns the value the variable has been set to.", "The Program saves the Char Index of the current Task, the 10 Variables (which reset to 0 as soon as the Program Loop
                stops), the 10 Member Variables and the remaining waiting Time in its NBT.",
                "A = 10, B = 11, C = 12, D = 13, E = 14, F = 15, just for Hexadecimal Space saving, since Redstone has only 4 Bits.",
                "For implementing Loops you just need 1 Punch Card per Loop, these Cards can restart once they are finished, depending on how many other Cards there are in the Program Loop you inserted your Card into, since it will
                process them procedurally.",
        ...
        doMiscFluidProcessing();

        loadPotions();

        loadPotionContainers();
        if (!GT_Values.D1) {
            try {
        ...
        //FluidContainerRegistry.registerFluidContainer(new FluidContainerRegistry.FluidContainerData(Materials.Naquadah.getMolten(1000L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Naquadah, 1L), GT_OreDictUnificator.get
        // (OrePrefixes.cell, Materials.Empty, 1L)));
        //FluidContainerRegistry.registerFluidContainer(new FluidContainerRegistry.FluidContainerData(Materials.NaquadahEnriched.getMolten(1000L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.NaquadahEnriched, 1L),
        // GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Empty, 1L)));
        //FluidContainerRegistry.registerFluidContainer(new FluidContainerRegistry.FluidContainerData(Materials.Naquadria.getMolten(1000L), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Naquadria, 1L), GT_OreDictUnificator.get
        // (OrePrefixes.cell, Materials.Empty, 1L)));

        GregTech_API.registerMachineBlock(GT_Utility.getBlockFromStack(GT_ModHandler.getIC2Item("reinforcedGlass", 0)), 0);
    }

    private static void loadReactorStuff() {
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Neutron_Reflector.get(1L),
                                        GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE,
                                        new Object[]{"RRR", "RPR", "RRR", 'R', GT_ModHandler.getIC2Item("reactorReflectorThick", 1L, 1), 'P', OrePrefixes.plateAlloy.get(Materials.Iridium)}
                                       );
        GT_ModHandler.addCraftingRecipe(ItemList.Neutron_Reflector.get(1L),
                                        GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE,
                                        new Object[]{"RBR",
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Reactor_Coolant_He_1.get(1L),
                                        GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE,
                                        new Object[]{" P ", "PCP", " P ", 'C', OrePrefixes.cell.get(Materials.Helium), 'P', OrePrefixes.plate.get(Materials.Tin)}
                                       );
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Reactor_Coolant_He_3.get(1L),
                                        GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE,
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Reactor_Coolant_He_6.get(1L),
                                        GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE,
                                        new Object[]{"PCP", "PDP", "PCP", 'C', ItemList.Reactor_Coolant_He_3, 'P', OrePrefixes.plate.get(Materials.Tin), 'D', OrePrefixes.plateDense.get(Materials.Copper)}
                                       );

        ItemList.Reactor_Coolant_NaK_1.set(GregTech_API.constructCoolantCellItem("60k_NaK_Coolantcell", "60k NaK Coolantcell", 60000));
        GT_ModHandler.addCraftingRecipe(ItemList.Reactor_Coolant_NaK_1.get(1L),
                                        GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE,
                                        new Object[]{"TST",
                                                     "PCP",
                                                     "TST",
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Reactor_Coolant_NaK_3.get(1L),
                                        GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE,
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Reactor_Coolant_NaK_6.get(1L),
                                        GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE,
                                        new Object[]{"PCP", "PDP", "PCP", 'C', ItemList.Reactor_Coolant_NaK_3, 'P', OrePrefixes.plate.get(Materials.Tin), 'D', OrePrefixes.plateDense.get(Materials.Copper)}
                                       );
        ...
        if (!GregTech_API.mIC2Classic) {
            ...
            ItemList.NaquadahCell_1.set(new GT_RadioactiveCellIC_Item("Naquadahcell", "Fuel Rod (Naquadah)", 1, 100000, 4F, 1, 1F, ItemList.Depleted_Naquadah_1.get(1), false));
            ItemList.NaquadahCell_2.set(new GT_RadioactiveCellIC_Item("Double_Naquadahcell", "Dual Fuel Rod (Naquadah)", 2, 100000, 4F, 1, 1F, ItemList.Depleted_Naquadah_2.get(1), false));
            ItemList.NaquadahCell_4.set(new GT_RadioactiveCellIC_Item("Quad_Naquadahcell", "Quad Fuel Rod (Naquadah)", 4, 100000, 4F, 1, 1F, ItemList.Depleted_Naquadah_4.get(1), false));

            GT_Values.RA.addCentrifugeRecipe(ItemList.Depleted_Naquadah_1.get(1),
                                             null,
                                             null,
                                             null,
            ...
            GT_Values.RA.addCentrifugeRecipe(ItemList.Depleted_Naquadah_2.get(1),
                                             null,
                                             null,
                                             null,
            ...
            GT_Values.RA.addCentrifugeRecipe(ItemList.Depleted_Naquadah_4.get(1),
                                             null,
                                             null,
                                             null,
            ...
            ItemList.MNqCell_1.set(new GT_RadioactiveCellIC_Item("MNqCell", "Fuel Rod (Nq* - MOX like behaviour)", 1, 100000, 4F, 1, 1F, ItemList.Depleted_MNq_1.get(1), true));
            ItemList.MNqCell_2.set(new GT_RadioactiveCellIC_Item("Double_MNqCell", "Dual Fuel Rod (Nq* - MOX like behaviour)", 2, 100000, 4F, 1, 1F, ItemList.Depleted_MNq_2.get(1), true));
            ItemList.MNqCell_4.set(new GT_RadioactiveCellIC_Item("Quad_MNqCell", "Quad Fuel Rod (Nq* - MOX like behaviour)", 4, 100000, 4F, 1, 1F, ItemList.Depleted_MNq_4.get(1), true));

            GT_Values.RA.addCentrifugeRecipe(ItemList.Depleted_MNq_1.get(1),
                                             null,
                                             null,
                                             null,
                                             GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Naquadah, 1L),
            ...
            GT_Values.RA.addCentrifugeRecipe(ItemList.Depleted_MNq_2.get(1),
                                             null,
                                             null,
                                             null,
                                             GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Naquadah, 2L),
            ...
            GT_Values.RA.addCentrifugeRecipe(ItemList.Depleted_MNq_4.get(1),
                                             null,
                                             null,
                                             null,
                                             GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Naquadah, 4L),
    ...
    private static void loadGTMachineBlocks() {
    ...
    private static void loadMetalBlocks() {
        GregTech_API.sBlockMetal1 = new GT_Block_Metal("gt.blockmetal1",
                                                       new Materials[]{Materials.Adamantium,
                                                                       Materials.Aluminium,
                                                                       Materials.Americium,
                                                                       ...
                                                                       Materials.Brass},
                                                       OrePrefixes.block,
                                                       Textures.BlockIcons.STORAGE_BLOCKS1
        );

        GregTech_API.sBlockMetal2 = new GT_Block_Metal("gt.blockmetal2",
                                                       new Materials[]{Materials.Bronze,
                                                                       Materials.Caesium,
                                                                       Materials.Cerium,
                                                                       Materials.Chrome,
                                                                       ...
                                                                       Materials.Electrum},
                                                       OrePrefixes.block,
                                                       Textures.BlockIcons.STORAGE_BLOCKS2
        );

        GregTech_API.sBlockMetal3 = new GT_Block_Metal("gt.blockmetal3",
                                                       new Materials[]{Materials.ElectrumFlux,
                                                                       Materials.Enderium,
                                                                       Materials.Erbium,
                                                                       Materials.Europium,
                                                                       ...
                                                                       Materials.Kanthal},
                                                       OrePrefixes.block,
                                                       Textures.BlockIcons.STORAGE_BLOCKS3
        );

        GregTech_API.sBlockMetal4 = new GT_Block_Metal("gt.blockmetal4",
                                                       new Materials[]{Materials.Knightmetal,
                                                                       Materials.Lanthanum,
                                                                       Materials.Lead,
                                                                       Materials.Lutetium,
                                                                       Materials.Magnalium,
                                                                       ...
                                                                       Materials.Naquadria},
                                                       OrePrefixes.block,
                                                       Textures.BlockIcons.STORAGE_BLOCKS4
        );

        GregTech_API.sBlockMetal5 = new GT_Block_Metal("gt.blockmetal5",
                                                       new Materials[]{Materials.Neodymium,
                                                       ...
                                                       OrePrefixes.block,
                                                       Textures.BlockIcons.STORAGE_BLOCKS5
        );

        GregTech_API.sBlockMetal6 = new GT_Block_Metal("gt.blockmetal6",
                                                       new Materials[]{Materials.Promethium,
                                                                       Materials.RedAlloy,
                                                                       Materials.RedSteel,
                                                                       Materials.RoseGold,
                                                                       Materials.Rubidium,
                                                       ...
                                                       OrePrefixes.block,
                                                       Textures.BlockIcons.STORAGE_BLOCKS6
        );

        GregTech_API.sBlockMetal7 = new GT_Block_Metal("gt.blockmetal7",
                                                       new Materials[]{Materials.Sunnarium,
                                                                       Materials.Tantalum,
                                                                       Materials.Tellurium,
                                                                       Materials.Terbium,
                                                                       Materials.Thaumium,
                                                       ...
                                                       OrePrefixes.block,
                                                       Textures.BlockIcons.STORAGE_BLOCKS7
        );

        GregTech_API.sBlockMetal8 = new GT_Block_Metal("gt.blockmetal8",
                                                       new Materials[]{Materials.Vanadium,
                                                                       ...
                                                                       Materials.Shadow},
                                                       OrePrefixes.block,
                                                       Textures.BlockIcons.STORAGE_BLOCKS8
        );
    }

    private static void loadGemBlocks() {
        GregTech_API.sBlockGem1 = new GT_Block_Metal("gt.blockgem1",
                                                     new Materials[]{Materials.InfusedAir,
                                                                     Materials.Amber,
                                                                     Materials.Amethyst,
                                                                     ...
                                                                     Materials.Jasper},
                                                     OrePrefixes.block,
                                                     Textures.BlockIcons.STORAGE_BLOCKS9
        );

        GregTech_API.sBlockGem2 = new GT_Block_Metal("gt.blockgem2",
                                                     ...
                                                     OrePrefixes.block,
                                                     Textures.BlockIcons.STORAGE_BLOCKS10
        );

        GregTech_API.sBlockGem3 = new GT_Block_Metal("gt.blockgem3",
                                                     new Materials[]{Materials.Topaz, Materials.Vinteum, Materials.GarnetYellow, Materials.NetherStar, Materials.Charcoal, Materials.Blaze},
                                                     OrePrefixes.block,
                                                     Textures.BlockIcons.STORAGE_BLOCKS11
        );
    }

    private static void doTERegistration() {
    ...
    private static void loadBasicGases() {
        ...
        GT_Mod.gregtechproxy.addFluid("Titaniumtetrachloride",
    ...
    private static void loadOils() {
        ...
        ItemList.sTailings         = GT_Mod.gregtechproxy.addFluid("liquid_tailings", "Tailings", null, 1, 295);
        ...
        GT_Mod.gregtechproxy.addFluid("liquid_medium_oil", "Refined Oil", Materials.OilMedium, 1, 295, GT_OreDictUnificator.get(OrePrefixes.cell, Materials.OilMedium, 1L), ItemList.Cell_Empty.get(1L), 1000);
        ...
        ItemList.sHydricSulfur = GT_Mod.gregtechproxy.addFluid("liquid_hydricsulfur",
                                                               "Hydrogen Sulfide",
    ...
    private static void loadMiscFluids() {
        GT_Mod.gregtechproxy.addFluid("charcoal_byproducts",
        ...
        GT_Mod.gregtechproxy.addFluid("molten.bisphenol_a",
                                      "molten.autogenerated",
                                      "Molten Bisphenol A",
    ...
    private static void doMiscFluidProcessing() {
    ...
    private static void loadPotionContainers() {
    ...
    private static void loadMiscExternalOreDictEntries() {
