...
public class GT_ModHandler {
    ...
    private static final ItemStack[][] sShapes1 = new ItemStack[][]{
            {sMt1, null, sMt1, sMt1, sMt1, sMt1, null, sMt1, null}, {sMt1, null, sMt1, sMt1, null, sMt1, sMt1, sMt1, sMt1},
            {null, sMt1, null, sMt1, sMt1, sMt1, sMt1, null, sMt1}, {sMt1, sMt1, sMt1, sMt1, null, sMt1, null, null, null},
            {sMt1, null, sMt1, sMt1, sMt1, sMt1, sMt1, sMt1, sMt1}, {sMt1, sMt1, sMt1, sMt1, null, sMt1, sMt1, null, sMt1},
            {null, null, null, sMt1, null, sMt1, sMt1, null, sMt1}, {null, sMt1, null, null, sMt1, null, null, sMt2, null},
            {sMt1, sMt1, sMt1, null, sMt2, null, null, sMt2, null}, {null, sMt1, null, null, sMt2, null, null, sMt2, null},
            {sMt1, sMt1, null, sMt1, sMt2, null, null, sMt2, null}, {null, sMt1, sMt1, null, sMt2, sMt1, null, sMt2, null},
            {sMt1, sMt1, null, null, sMt2, null, null, sMt2, null}, {null, sMt1, sMt1, null, sMt2, null, null, sMt2, null},
            {null, sMt1, null, sMt1, null, null, null, sMt1, sMt2}, {null, sMt1, null, null, null, sMt1, sMt2, sMt1, null},
            {null, sMt1, null, sMt1, null, sMt1, null, null, sMt2}, {null, sMt1, null, sMt1, null, sMt1, sMt2, null, null},
            {null, sMt2, null, null, sMt1, null, null, sMt1, null}, {null, sMt2, null, null, sMt2, null, sMt1, sMt1, sMt1},
            {null, sMt2, null, null, sMt2, null, null, sMt1, null}, {null, sMt2, null, sMt1, sMt2, null, sMt1, sMt1, null},
            {null, sMt2, null, null, sMt2, sMt1, null, sMt1, sMt1}, {null, sMt2, null, null, sMt2, null, sMt1, sMt1, null},
            {sMt1, null, null, null, sMt2, null, null, null, sMt2}, {null, null, sMt1, null, sMt2, null, sMt2, null, null},
            {sMt1, null, null, null, sMt2, null, null, null, null}, {null, null, sMt1, null, sMt2, null, null, null, null},
            {sMt1, sMt2, null, null, null, null, null, null, null}, {sMt2, sMt1, null, null, null, null, null, null, null},
            {sMt1, null, null, sMt2, null, null, null, null, null}, {sMt2, null, null, sMt1, null, null, null, null, null},
            {sMt1, sMt1, sMt1, sMt1, sMt1, sMt1, null, sMt2, null}, {sMt1, sMt1, null, sMt1, sMt1, sMt2, sMt1, sMt1, null},
            {null, sMt1, sMt1, sMt2, sMt1, sMt1, null, sMt1, sMt1}, {null, sMt2, null, sMt1, sMt1, sMt1, sMt1, sMt1, sMt1},
            {sMt1, sMt1, sMt1, sMt1, sMt2, sMt1, null, sMt2, null}, {sMt1, sMt1, null, sMt1, sMt2, sMt2, sMt1, sMt1, null},
            {null, sMt1, sMt1, sMt2, sMt2, sMt1, null, sMt1, sMt1}, {null, sMt2, null, sMt1, sMt2, sMt1, sMt1, sMt1, sMt1},
            {sMt1, null, null, null, sMt1, null, null, null, null}, {null, sMt1, null, sMt1, null, null, null, null, null},
            {sMt1, sMt1, null, sMt2, null, sMt1, sMt2, null, null}, {null, sMt1, sMt1, sMt1, null, sMt2, null, null, sMt2}
    };
    ...
    /**
     * @param aValue the Value of this Stack, when burning inside a Furnace (200 = 1 Burn Process = 500 EU, max = 32767 (that is 81917.5 EU)), limited to
    ...
    /**
     * @return the Value of this Stack, when burning inside a Furnace (200 = 1 Burn Process = 500 EU, max = 32767 (that is 81917.5 EU)), limited to Short
     * because the vanilla Furnace otherwise can't handle it properly, stupid Mojang...
     */
    ...
    public static boolean addScrapboxDrop(float aChance, ItemStack aOutput) {
        ...
        try {
            GT_Utility.callMethod(
                    GT_Utility.getFieldContent("ic2.api.recipe.Recipes", "scrapboxDrops", true, true), "addDrop", true, false, true,
                    GT_Utility.copyOrNull(aOutput), aChance
                                 );
            GT_Utility.callMethod(
                    GT_Utility.getFieldContent("ic2.api.recipe.Recipes", "scrapboxDrops", true, true), "addRecipe", true, true, false,
                    GT_Utility.copyOrNull(aOutput), aChance
                                 );
        } catch (Throwable e) {/*Do nothing*/}
        return true;
    ...
    public static boolean addSmeltingAndAlloySmeltingRecipe(ItemStack aInput, ItemStack aOutput, boolean hidden) {
        ...
        if (RA.addAlloySmelterRecipe(aInput, OrePrefixes.ingot.contains(aOutput) ? ItemList.Shape_Mold_Ingot.get(0) : OrePrefixes.block.contains(aOutput) ? ItemList.Shape_Mold_Block.get(0)
                                                                                                                                                          : OrePrefixes.nugget.contains(aOutput)
    ...
    public static boolean addInductionSmelterRecipe(ItemStack aInput1, ItemStack aInput2, ItemStack aOutput1, ItemStack aOutput2, int aEnergy, int aChance) {
        ...
        if (!GT_Mod.gregtechproxy.mTEMachineRecipes && !GregTech_API.sRecipeFile.get(
                ConfigCategories.Machines.inductionsmelter, aInput2 == null ? aInput1 : aOutput1, true)) {
            return false;
        }
        try {
            ThermalExpansion.addSmelterRecipe(
                    aEnergy * 10, GT_Utility.copyOrNull(aInput1), aInput2 == null ? new ItemStack(Blocks.sand, 1, 0) : aInput2, aOutput1, aOutput2, aChance);
        } catch (Throwable e) {/*Do nothing*/}
        return true;
    }
    ...
    public static boolean addLiquidTransposerEmptyRecipe(ItemStack aFullContainer, FluidStack aLiquid, ItemStack aEmptyContainer, int aMJ) {
        ...
        if (!GT_Mod.gregtechproxy.mTEMachineRecipes && !GregTech_API.sRecipeFile.get(
                ConfigCategories.Machines.liquidtransposeremptying, aFullContainer, true)) {
            return false;
        }
        try {
    ...
    public static boolean addPulverisationRecipe(
        ...
        if (GT_Utility.getContainerItem(aInput, false) == null) {
            ...
            RA.addPulveriserRecipe(
                    aInput, new ItemStack[]{aOutput1, aOutput2, aOutput3},
                    new int[]{10000, aChance2 <= 0 ? 1000 : 100 * aChance2, aChance3 <= 0 ? 1000 : 100 * aChance3}, 400, 2
                                  );
                ...
                if (Materials.Wood.contains(aOutput1)) {
                    if (aEnableTEMachineRecipes && GregTech_API.sRecipeFile.get(ConfigCategories.Machines.pulverization, aInput, true)) {
                        if (aOutput2 == null) {
                            ...
                            ThermalExpansion.addSawmillRecipe(32000, GT_Utility.copyOrNull(aInput), GT_Utility.copyOrNull(aOutput1),
                                                              GT_Utility.copyOrNull(aOutput2), aChance2 <= 0 ? 10 : aChance2
                                                             );
                        }
                    }
                } else {
                    if (GregTech_API.sRecipeFile.get(ConfigCategories.Machines.rockcrushing, aInput, true)) {
                        try {
                            if (GT_Utility.getBlockFromStack(aInput) != Blocks.obsidian && GT_Utility.getBlockFromStack(aInput) != Blocks.gravel) {
                                mods.railcraft.api.crafting.IRockCrusherRecipe tRecipe =
                                        mods.railcraft.api.crafting.RailcraftCraftingManager.rockCrusher.createNewRecipe(
                                                GT_Utility.copyAmount(1, aInput), aInput.getItemDamage() != W, false);
   ...
   /*     if(GregTech_API.mMagneticraft && GT_Mod.gregtechproxy.mMagneticraftRecipes){
          ...
          if(tData!=null&&tData.mPrefix!=null){
            if(tData.mPrefix==OrePrefixes.ore||tData.mPrefix==OrePrefixes.oreBlackgranite||tData.mPrefix==OrePrefixes.oreEndstone||tData.mPrefix==OrePrefixes
            .oreNetherrack||tData.mPrefix==OrePrefixes.oreRedgranite){
            	com.cout970.magneticraft.api.access.MgRecipeRegister.registerCrusherRecipe(aInput, aOutput1, aOutput2,(float)((float)aChance2/GT_Mod
            	.gregtechproxy.mMagneticraftBonusOutputPercent), aOutput3,(float)((float)aChance3/GT_Mod.gregtechproxy.mMagneticraftBonusOutputPercent));
        	  ...
        	  com.cout970.magneticraft.api.access.MgRecipeRegister.registerGrinderRecipe(aInput, aOutput1, aOutput2,(float)((float)aChance2/GT_Mod
 .gregtechproxy.mMagneticraftBonusOutputPercent), aOutput3,(float)((float)aChance3/GT_Mod.gregtechproxy.mMagneticraftBonusOutputPercent));
          	}
          }
        }
    ...
    public static boolean addAlloySmelterRecipe(
        ...
        aOutput1 = GT_OreDictUnificator.get(true, aOutput1);
        boolean temp = RA.addAlloySmelterRecipe(aInput1, aInput2, aOutput1, aDuration, aEUt);
        if (GT_Mod.gregtechproxy.mTEMachineRecipes) {
    ...
    public static boolean addThermalCentrifugeRecipe(ItemStack aInput, int[] aChances, int aHeat, Object... aOutput) {
        ...
        RA.addThermalCentrifugeRecipe(
                aInput, aOutput.length >= 1 ? (ItemStack) aOutput[0] : null, aOutput.length >= 2 ? (ItemStack) aOutput[1] : null,
                aOutput.length >= 3 ? (ItemStack) aOutput[2] : null, aChances, 500, 48
                                     );
        return true;
    }
    ...
    public static boolean addThermalCentrifugeRecipe(ItemStack aInput, int aHeat, Object... aOutput) {
        ...
        RA.addThermalCentrifugeRecipe(
                aInput, aOutput.length >= 1 ? (ItemStack) aOutput[0] : null, aOutput.length >= 2 ? (ItemStack) aOutput[1] : null,
                aOutput.length >= 3 ? (ItemStack) aOutput[2] : null, 500, 48
                                     );
        return true;
    }
    ...
    public static boolean addOreWasherRecipe(ItemStack aInput, int[] aChances, int aWaterAmount, Object... aOutput) {
        ...
        RA.addOreWasherRecipe(
                aInput, (ItemStack) aOutput[0], (ItemStack) aOutput[1], (ItemStack) aOutput[2], GT_ModHandler.getWater(aWaterAmount), aChances, 500, 16);
        RA.addOreWasherRecipe(
                aInput, (ItemStack) aOutput[0], (ItemStack) aOutput[1], (ItemStack) aOutput[2], GT_ModHandler.getDistilledWater(aWaterAmount / 5), aChances,
                300, 16
                             );
        return true;
    }
    ...
    public static boolean addOreWasherRecipe(ItemStack aInput, int aWaterAmount, Object... aOutput) {
        ...
        RA.addOreWasherRecipe(
                aInput, (ItemStack) aOutput[0], (ItemStack) aOutput[1], (ItemStack) aOutput[2], GT_ModHandler.getDistilledWater(aWaterAmount / 5), 300, 16);
        return true;
    }
    ...
    public static boolean addRollingMachineRecipe(ItemStack aResult, Object[] aRecipe) {
        ...
        try {
            mods.railcraft.api.crafting.RailcraftCraftingManager.rollingMachine.getRecipeList().add(
                    new ShapedOreRecipe(GT_Utility.copyOrNull(aResult), aRecipe));
        } catch (Throwable e) {
    ...
    public static boolean addCraftingRecipe(ItemStack aResult, long aBitMask, Object[] aRecipe) {
        return addCraftingRecipe(aResult, new Enchantment[0], new int[0], (aBitMask & RecipeBits.MIRRORED) != 0, (aBitMask & RecipeBits.BUFFERED) != 0,
                                 (aBitMask & RecipeBits.KEEPNBT) != 0, (aBitMask & RecipeBits.DISMANTLEABLE) != 0, (aBitMask & RecipeBits.NOT_REMOVABLE) == 0,
                                 ...
                                 (aBitMask & RecipeBits.DELETE_ALL_OTHER_SHAPED_RECIPES) != 0, (aBitMask & RecipeBits.DELETE_ALL_OTHER_NATIVE_RECIPES) != 0,
                                 (aBitMask & RecipeBits.DO_NOT_CHECK_FOR_COLLISIONS) == 0,
                                 (aBitMask & RecipeBits.ONLY_ADD_IF_THERE_IS_ANOTHER_RECIPE_FOR_IT) != 0,
                                 (aBitMask & RecipeBits.ONLY_ADD_IF_RESULT_IS_NOT_NULL) != 0, (aBitMask & RecipeBits.CHECK_NBT) != 0, aRecipe
                                );
    }
    ...
    private static boolean addCraftingRecipe(
        ...
        for (byte i = 0; i < aRecipe.length; i++) {
            if (aRecipe[i] instanceof IItemContainer) {
                ...
                aRecipe[i] = ((Enum) aRecipe[i]).name();
                    ...
                    aRecipe[i] == null || aRecipe[i] instanceof ItemStack || aRecipe[i] instanceof ItemData || aRecipe[i] instanceof String ||
        ...
        if (aRemoveAllOthersWithSameOutput || aRemoveAllOthersWithSameOutputIfTheyHaveSameNBT || aRemoveAllOtherShapedsWithSameOutput ||
            aRemoveAllOtherNativeRecipes) {
            if (tDoWeCareIfThereWasARecipe || !aBuffered) {
                tThereWasARecipe = removeRecipeByOutput(
                        aResult, !aRemoveAllOthersWithSameOutputIfTheyHaveSameNBT, aRemoveAllOtherShapedsWithSameOutput, aRemoveAllOtherNativeRecipes) ||
                                   tThereWasARecipe;
            } else {
        ...
        if (tThereWasARecipe || !aOnlyAddIfThereIsAnyRecipeOutputtingThis) {
            if (sBufferCraftingRecipes && aBuffered) {
                sBufferRecipeList.add(new GT_Shaped_Recipe(GT_Utility.copyOrNull(aResult), aDismantleable, aRemovable, aKeepNBT, aCheckNBT, aEnchantmentsAdded,
                                                           aEnchantmentLevelsAdded, aRecipe
                ).setMirrored(aMirrored));
            } else {
                GameRegistry.addRecipe(new GT_Shaped_Recipe(GT_Utility.copyOrNull(aResult), aDismantleable, aRemovable, aKeepNBT, aCheckNBT, aEnchantmentsAdded,
                                                            aEnchantmentLevelsAdded, aRecipe
                ).setMirrored(aMirrored));
            }
        }
    ...
    public static ItemStack removeRecipe(ItemStack... aRecipe) {
        ...
        try {
            for (int i = 0; i < tList_sS; i++) {
                for (; i < tList_sS; i++) {
                    if ((!(tList.get(i) instanceof IGT_CraftingRecipe) || ((IGT_CraftingRecipe) tList.get(i)).isRemovable()) && tList.get(i).matches(
                            aCrafting, DW)) {
    ...
    public static boolean removeRecipeByOutput(ItemStack aOutput, boolean aIgnoreNBT, boolean aNotRemoveShapelessRecipes, boolean aOnlyRemoveNativeHandlers) {
        ...
        for (int i = 0; i < tList_sS; i++) {
            ...
            if ((!(tRecipe instanceof IGT_CraftingRecipe) || ((IGT_CraftingRecipe) tRecipe).isRemovable()) && GT_Utility.areStacksEqual(
                    GT_OreDictUnificator.get(tStack), aOutput, aIgnoreNBT)) {
                tList.remove(i--);
                tList_sS = tList.size();
                rReturn = true;
            }
    ...
    public static boolean addCraftingRecipe(ItemStack aResult, Enchantment[] aEnchantmentsAdded, int[] aEnchantmentLevelsAdded, Object[] aRecipe) {
        return addCraftingRecipe(
                aResult, aEnchantmentsAdded, aEnchantmentLevelsAdded, false, true, false, false, false, false, false, false, false, false, false, false, true,
                false, aRecipe);
    }
    ...
    private static boolean addShapelessCraftingRecipe(
        ...
        if (sBufferCraftingRecipes && aBuffered) {
            sBufferRecipeList.add(
                    new GT_Shapeless_Recipe(GT_Utility.copyOrNull(aResult), aDismantleable, aRemovable, aKeepNBT, aEnchantmentsAdded, aEnchantmentLevelsAdded,
                                            aRecipe
                    ));
        } else {
    ...
    public static boolean addShapelessCraftingRecipe(ItemStack aResult, long aBitMask, Object[] aRecipe) {
        return addShapelessCraftingRecipe(
                aResult, new Enchantment[0], new int[0], (aBitMask & RecipeBits.BUFFERED) != 0, (aBitMask & RecipeBits.KEEPNBT) != 0,
    ...
    public static ItemStack getRecipeOutput(boolean aUncopiedStack, boolean allowOreDict, ItemStack... aRecipe) {
        ...
        for (IRecipe iRecipe : tList) {
            found = false;
            if (!allowOreDict && iRecipe instanceof ShapedOreRecipe) {
                continue;
            }
    ...
    public static List<ItemStack> getVanillyToolRecipeOutputs(ItemStack... aRecipe) {
        ...
        if (sSingleNonBlockDamagableRecipeList.isEmpty()) {
                    ...
                    if (!(tRecipe instanceof ShapelessRecipes || tRecipe instanceof ShapelessOreRecipe)) {
                        if (tRecipe instanceof ShapedOreRecipe) {
                            ...
                            for (Object tObject : ((ShapedOreRecipe) tRecipe).getInput()) {
                                if (tObject != null) {
                                    if (tObject instanceof ItemStack && (
                                            ...
                                            ((ItemStack) tObject).getMaxDamage() > 0 || ((ItemStack) tObject).getItem() instanceof ItemBlock
                                    )) {
                                        temp = false;
                                        break;
                                    }
                            ...
                            for (ItemStack tObject : ((ShapedRecipes) tRecipe).recipeItems) {
                                if (tObject != null && (
                                        tObject.getItem() == null || tObject.getMaxStackSize() < 2 || tObject.getMaxDamage() > 0 ||
            ...
            GT_Log.out.println("GT_Mod: Created a List of Tool Recipes containing " + sSingleNonBlockDamagableRecipeList.size() + " Recipes for recycling." + (
                    sSingleNonBlockDamagableRecipeList.size() > 1024 ? " Scanning all these Recipes is the reason for the startup Lag you receive right now."
                                                                     : E
            ));
        }
    ...
    public static List<ItemStack> getRecipeOutputs(List<IRecipe> aList, boolean aDeleteFromList, ItemStack... aRecipe) {
        ...
        if (!aDeleteFromList) {
            ...
            rList = stacks.stream().filter(tOutput -> tOutput.stackSize == 1 && tOutput.getMaxDamage() > 0 && tOutput.getMaxStackSize() == 1).collect(
                    Collectors.toList());
        } else {
            ...
            bufferedRecipes = (List<IRecipe>) CraftingManager.getInstance().getRecipeList().stream().filter(
                                                             ...
                                                             .filter(tRecipe -> {
                                                                 try {
                                                                     ...
                                                                     if (tOutput.stackSize == 1 && tOutput.getMaxDamage() > 0 &&
    ...
    public static ItemStack getSmeltingOutput(ItemStack aInput, boolean aRemoveInput, ItemStack aOutputSlot) {
        ...
        if (rStack != null && (
                aOutputSlot == null || (
                        GT_Utility.areStacksEqual(rStack, aOutputSlot) && rStack.stackSize + aOutputSlot.stackSize <= aOutputSlot.getMaxStackSize()
                )
        )) {
            if (aRemoveInput) {
                aInput.stackSize--;
...
//			if (isElectricItem(aStack) &&  (aIgnoreDischargability || ((ic2.api.item.IElectricItem)aStack.getItem()).canProvideEnergy(aStack))) {
            if (isElectricItem(aStack)) {
                ...
                if (tTier < 0 || tTier == aTier || aTier == Integer.MAX_VALUE) {
                    ...
                    if (aCharge > 0) {
//						int rCharge = Math.max(0, ic2.api.item.ElectricItem.manager.discharge(aStack, aCharge + (aCharge * 4 > aTier ? aTier : 0), tTier, T,
                    //						aSimulate));
                        int rCharge = (int) Math.max(
                                0, ic2.api.item.ElectricItem.manager.discharge(aStack, aCharge + (aCharge * 4 > aTier ? aTier : 0), tTier, true,
                                                                               !aIgnoreDischargability, aSimulate
                                                                              ));
                        return rCharge - (rCharge * 4 > aTier ? aTier : 0);
                    }
                }
