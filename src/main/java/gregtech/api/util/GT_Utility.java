...
public class GT_Utility {
    ...
    public static class ItemNBT {
        ...
        public static void setAdvancedProspectionData(
                byte aTier, ItemStack aStack, int aX, short aY, int aZ, int aDim, ArrayList<String> aOils, ArrayList<String> aOres, int aRadius
                                                     ) {
            ...
            tOilsPosStr = tOilsPosStr.concat("            X: " + (Math.floorDiv(aX, 16 * 8) + 1) * 16 * 8 + " Z: " + (Math.floorDiv(aZ, 16 * 8) + 1) * 16 *
                                                                                                                     8); // +1 oilfied to find bottomright of
 // [5]
    ...
    public static Field getField(Object aObject, String aField, boolean aPrivate, boolean aLogErrors) {
        try {
            Field tField = (aObject instanceof Class) ? ((Class) aObject).getDeclaredField(aField) : (aObject instanceof String) ? Class.forName(
                    (String) aObject).getDeclaredField(aField) : aObject.getClass().getDeclaredField(aField);
            if (aPrivate) {
    ...
    public static Object callMethod(
        ...
        try {
            ...
            Method tMethod = (aObject instanceof Class) ? ((Class) aObject).getMethod(aMethod, tParameterTypes) : aObject.getClass().getMethod(
                    aMethod, tParameterTypes);
            if (aPrivate) {
    ...
    public static byte moveStackIntoPipe(
        ...
        return moveStackIntoPipe(
                aTileEntity1, aTileEntity2, aGrabSlots, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize, aMaxMoveAtOnce,
                aMinMoveAtOnce, true
                                );
    }
    ...
    public static byte moveStackIntoPipe(
        ...
        if (aTileEntity1 == null || aMaxTargetStackSize <= 0 || aMinTargetStackSize <= 0 || aMinTargetStackSize > aMaxTargetStackSize || aMaxMoveAtOnce <= 0 ||
                        ...
                        if (isAllowedToTakeFromSlot(aTileEntity1, aGrabSlot, (byte) aGrabFrom, aTileEntity1.getStackInSlot(aGrabSlot))) {
                            if (Math.max(aMinMoveAtOnce, aMinTargetStackSize) <= aTileEntity1.getStackInSlot(aGrabSlot).stackSize) {
                                ItemStack tStack = copyAmount(
                                        Math.min(aTileEntity1.getStackInSlot(aGrabSlot).stackSize, Math.min(aMaxMoveAtOnce, aMaxTargetStackSize)),
                                ...
                                if (tMovedItemCount >= 1/*Math.max(aMinMoveAtOnce, aMinTargetStackSize)*/) {
                                    //((cofh.api.transport.IItemConduit)aTileEntity2).insertItem(ForgeDirection.getOrientation(aPutTo), copyAmount
 // (tMovedItemCount, tStack), F);
                        ...
                        if (isAllowedToTakeFromSlot(aTileEntity1, aGrabSlot, (byte) aGrabFrom, aTileEntity1.getStackInSlot(aGrabSlot))) {
                            if (Math.max(aMinMoveAtOnce, aMinTargetStackSize) <= aTileEntity1.getStackInSlot(aGrabSlot).stackSize) {
                                ...
                                byte tMovedItemCount = (byte) ((buildcraft.api.transport.IPipeTile) aTileEntity2).injectItem(
                                        copyOrNull(tStack), false, ForgeDirection.getOrientation(aPutTo));
                                if (tMovedItemCount >= Math.max(aMinMoveAtOnce, aMinTargetStackSize)) {
                                    tMovedItemCount = (byte) (
                                            ((buildcraft.api.transport.IPipeTile) aTileEntity2).injectItem(
                                                    copyAmount(tMovedItemCount, tStack), true, ForgeDirection.getOrientation(aPutTo))
                                    );
                                    aTileEntity1.decrStackSize(aGrabSlot, tMovedItemCount);
                                    aTileEntity1.markDirty();
                                    return tMovedItemCount;
        ...
        if (aTileEntity1 instanceof TileEntity && tDirection != ForgeDirection.UNKNOWN && tDirection.getOpposite() == ForgeDirection.getOrientation(aPutTo)) {
            int tX = ((TileEntity) aTileEntity1).xCoord + tDirection.offsetX, tY = ((TileEntity) aTileEntity1).yCoord + tDirection.offsetY, tZ =
                    ((TileEntity) aTileEntity1).zCoord + tDirection.offsetZ;
    ...
    public static byte moveStackFromSlotAToSlotB(
        ...
        if (aTileEntity1 == null || aTileEntity2 == null || aMaxTargetStackSize <= 0 || aMinTargetStackSize <= 0 || aMinTargetStackSize > aMaxTargetStackSize ||
            aMaxMoveAtOnce <= 0 || aMinMoveAtOnce > aMaxMoveAtOnce) {
            return 0;
        }
        ...
        if (tStack1 != null) {
            ...
            aMaxTargetStackSize = (byte) Math.min(
                    aMaxTargetStackSize, Math.min(tStack3.getMaxStackSize(), Math.min(tStack2 == null ? Integer.MAX_VALUE : tStack2.getMaxStackSize(),
            ...
            if (tStack3.stackSize + (tStack2 == null ? 0 : tStack2.stackSize) >= Math.min(tStack3.getMaxStackSize(), aMinTargetStackSize) &&
    ...
    public static boolean isAllowedToTakeFromSlot(IInventory aTileEntity, int aSlot, byte aSide, ItemStack aStack) {
        if (ForgeDirection.getOrientation(aSide) == ForgeDirection.UNKNOWN) {
            return isAllowedToTakeFromSlot(aTileEntity, aSlot, (byte) 0, aStack) || isAllowedToTakeFromSlot(aTileEntity, aSlot, (byte) 1, aStack) ||
                   isAllowedToTakeFromSlot(aTileEntity, aSlot, (byte) 2, aStack) || isAllowedToTakeFromSlot(aTileEntity, aSlot, (byte) 3, aStack) ||
                   isAllowedToTakeFromSlot(aTileEntity, aSlot, (byte) 4, aStack) || isAllowedToTakeFromSlot(aTileEntity, aSlot, (byte) 5, aStack);
        }
    ...
    public static boolean isAllowedToPutIntoSlot(IInventory aTileEntity, int aSlot, byte aSide, ItemStack aStack, byte aMaxStackSize) {
        ...
        if (ForgeDirection.getOrientation(aSide) == ForgeDirection.UNKNOWN) {
            return isAllowedToPutIntoSlot(aTileEntity, aSlot, (byte) 0, aStack, aMaxStackSize) || isAllowedToPutIntoSlot(
                    aTileEntity, aSlot, (byte) 1, aStack, aMaxStackSize) || isAllowedToPutIntoSlot(
                    aTileEntity, aSlot, (byte) 2, aStack, aMaxStackSize) || isAllowedToPutIntoSlot(aTileEntity, aSlot, (byte) 3, aStack, aMaxStackSize) ||
                   isAllowedToPutIntoSlot(
                           aTileEntity, aSlot, (byte) 4, aStack, aMaxStackSize) || isAllowedToPutIntoSlot(
    ...
    public static int moveMultipleItemStacks(
        ...
        if (aTileEntity1 instanceof IInventory) {
            return moveMultipleItemStacks((IInventory) aTileEntity1, aTileEntity2, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize,
                                          aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, aStackAmount, true
                                         );
        }
        return 0;
    }
    ...
    public static int moveMultipleItemStacks(
        ...
        if (aTileEntity1 == null || aMaxTargetStackSize <= 0 || aMinTargetStackSize <= 0 || aMaxMoveAtOnce <= 0 || aMinTargetStackSize > aMaxTargetStackSize ||
            aMinMoveAtOnce > aMaxMoveAtOnce || aMaxStackTransfer == 0) {
            return 0;
        }
        ...
        if (aTileEntity2 instanceof IInventory) {
                        ...
                        for (int tPutSlotIndex = tFirstsValidSlot; tPutSlotIndex < tPutInventorySize; tPutSlotIndex++) {
                            ...
                            if (isAllowedToPutIntoSlot(tPutInventory, tPutSlot, aPutTo, tGrabStack, (byte) 64)) {
                                int tMoved = moveStackFromSlotAToSlotB(
                                        aTileEntity1, tPutInventory, tGrabSlot, tPutSlot, aMaxTargetStackSize, aMinTargetStackSize,
                                        (byte) (aMaxMoveAtOnce - tMovedItems), aMinMoveAtOnce
                                                                      );
            ...
            if (aDoCheckChests && aTileEntity1 instanceof TileEntityChest) {
                ...
                if (tTileEntity1.adjacentChestXNeg != null) {
                    tAmount = moveMultipleItemStacks(
                            tTileEntity1.adjacentChestXNeg, aTileEntity2, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize,
                            aMaxMoveAtOnce, aMinMoveAtOnce, maxStackTransfer, false
                                                    );
                } else if (tTileEntity1.adjacentChestZNeg != null) {
                    tAmount = moveMultipleItemStacks(
                            tTileEntity1.adjacentChestZNeg, aTileEntity2, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize,
                            aMaxMoveAtOnce, aMinMoveAtOnce, maxStackTransfer, false
                                                    );
                } else if (tTileEntity1.adjacentChestXPos != null) {
                    tAmount = moveMultipleItemStacks(
                            tTileEntity1.adjacentChestXPos, aTileEntity2, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize,
                            aMaxMoveAtOnce, aMinMoveAtOnce, maxStackTransfer, false
                                                    );
                } else if (tTileEntity1.adjacentChestZPos != null) {
                    tAmount = moveMultipleItemStacks(
                            tTileEntity1.adjacentChestZPos, aTileEntity2, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize,
                            aMaxMoveAtOnce, aMinMoveAtOnce, maxStackTransfer, false
                                                    );
                }
                if (tAmount != 0) {
            ...
            if (aDoCheckChests && aTileEntity2 instanceof TileEntityChest) {
                ...
                if (tTileEntity2.adjacentChestChecked) {
                    ...
                    if (tTileEntity2.adjacentChestXNeg != null) {
                        tAmount = moveMultipleItemStacks(
                                aTileEntity1, tTileEntity2.adjacentChestXNeg, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize,
                                aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, maxStackTransfer, false
                                                        );
                    } else if (tTileEntity2.adjacentChestZNeg != null) {
                        tAmount = moveMultipleItemStacks(
                                aTileEntity1, tTileEntity2.adjacentChestZNeg, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize,
                                aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, maxStackTransfer, false
                                                        );
                    } else if (tTileEntity2.adjacentChestXPos != null) {
                        tAmount = moveMultipleItemStacks(
                                aTileEntity1, tTileEntity2.adjacentChestXPos, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize,
                                aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, maxStackTransfer, false
                                                        );
                    } else if (tTileEntity2.adjacentChestZPos != null) {
                        tAmount = moveMultipleItemStacks(
                                aTileEntity1, tTileEntity2.adjacentChestZPos, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize,
                                aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, maxStackTransfer, false
                                                        );
                    }
                    if (tAmount != 0) {
        ...
        for (int i = 0; i < tGrabInventorySize; i++) {
            int tMoved = moveStackIntoPipe(
                    aTileEntity1, aTileEntity2, tGrabSlots, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize, aMaxMoveAtOnce,
                    aMinMoveAtOnce, aDoCheckChests
                                          );
            if (tMoved == 0) {
                return tTotalItemsMoved;
            } else {
    ...
    public static byte moveOneItemStack(
        ...
        if (aTileEntity1 instanceof IInventory) {
            return moveOneItemStack((IInventory) aTileEntity1, aTileEntity2, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize,
                                    aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, true
                                   );
        }
        return 0;
    }
    ...
    public static byte moveOneItemStackIntoSlot(
        ...
        if (aTileEntity1 == null || !(aTileEntity1 instanceof IInventory) || aPutTo < 0 || aMaxTargetStackSize <= 0 || aMinTargetStackSize <= 0 ||
            aMaxMoveAtOnce <= 0 || aMinTargetStackSize > aMaxTargetStackSize || aMinMoveAtOnce > aMaxMoveAtOnce) {
            return 0;
        }
                ...
                if (listContainsItem(aFilter, ((IInventory) aTileEntity1).getStackInSlot(tGrabSlot), true, aInvertFilter)) {
                    if (isAllowedToTakeFromSlot((IInventory) aTileEntity1, tGrabSlot, aGrabFrom, ((IInventory) aTileEntity1).getStackInSlot(tGrabSlot))) {
                        if (isAllowedToPutIntoSlot(
                                (IInventory) aTileEntity2, aPutTo, (byte) 6, ((IInventory) aTileEntity1).getStackInSlot(tGrabSlot), aMaxTargetStackSize)) {
                            byte tMovedItemCount = moveStackFromSlotAToSlotB(
                                    (IInventory) aTileEntity1, (IInventory) aTileEntity2, tGrabSlot, aPutTo, aMaxTargetStackSize, aMinTargetStackSize,
                                    aMaxMoveAtOnce, aMinMoveAtOnce
                                                                            );
        ...
        moveStackIntoPipe(
                ((IInventory) aTileEntity1), aTileEntity2, tGrabSlots, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize,
                aMaxMoveAtOnce, aMinMoveAtOnce
                         );
        return 0;
    }
    ...
    public static byte moveFromSlotToSlot(
        ...
        if (aTileEntity1 == null || aTileEntity2 == null || aGrabFrom < 0 || aPutTo < 0 || aMaxTargetStackSize <= 0 || aMinTargetStackSize <= 0 ||
            aMaxMoveAtOnce <= 0 || aMinTargetStackSize > aMaxTargetStackSize || aMinMoveAtOnce > aMaxMoveAtOnce) {
            return 0;
        }
        if (listContainsItem(aFilter, aTileEntity1.getStackInSlot(aGrabFrom), true, aInvertFilter)) {
            if (isAllowedToTakeFromSlot(aTileEntity1, aGrabFrom, (byte) 6, aTileEntity1.getStackInSlot(aGrabFrom))) {
                if (isAllowedToPutIntoSlot(aTileEntity2, aPutTo, (byte) 6, aTileEntity1.getStackInSlot(aGrabFrom), aMaxTargetStackSize)) {
                    byte tMovedItemCount = moveStackFromSlotAToSlotB(
                            aTileEntity1, aTileEntity2, aGrabFrom, aPutTo, aMaxTargetStackSize, aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce);
                    if (tMovedItemCount > 0) {
                        return tMovedItemCount;
                    }
                }
    ...
    public static byte moveFromSlotToSide(
        ...
        if (fromTile == null || aGrabFrom < 0 || aMinTargetStackSize <= 0 || aMaxMoveAtOnce <= 0 || aMinTargetStackSize > aMaxTargetStackSize ||
            aMinMoveAtOnce > aMaxMoveAtOnce) {
            return 0;
        }

        if (!listContainsItem(aFilter, fromTile.getStackInSlot(aGrabFrom), true, aInvertFilter) || !isAllowedToTakeFromSlot(
                fromTile, aGrabFrom, (byte) 6, fromTile.getStackInSlot(aGrabFrom))) {
            return 0;
        }
            ...
            for (int tPutSlot : tPutSlots) {
                if (isAllowedToPutIntoSlot((IInventory) toTile, tPutSlot, aPutTo, fromTile.getStackInSlot(aGrabFrom), aMaxTargetStackSize)) {
                    tMovedItemCount += moveStackFromSlotAToSlotB(
                            fromTile, (IInventory) toTile, aGrabFrom, tPutSlot, aMaxTargetStackSize, aMinTargetStackSize,
                            (byte) (aMaxMoveAtOnce - tMovedItemCount), aMinMoveAtOnce
                                                                );
                ...
                if (tTileEntity2.adjacentChestChecked) {
                    if (tTileEntity2.adjacentChestXNeg != null) {
                        tMovedItemCount = moveFromSlotToSide(
                                fromTile, tTileEntity2.adjacentChestXNeg, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize,
                                aMaxMoveAtOnce, aMinMoveAtOnce, false
                                                            );
                    } else if (tTileEntity2.adjacentChestZNeg != null) {
                        tMovedItemCount = moveFromSlotToSide(
                                fromTile, tTileEntity2.adjacentChestZNeg, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize,
                                aMaxMoveAtOnce, aMinMoveAtOnce, false
                                                            );
                    } else if (tTileEntity2.adjacentChestXPos != null) {
                        tMovedItemCount = moveFromSlotToSide(
                                fromTile, tTileEntity2.adjacentChestXPos, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize,
                                aMaxMoveAtOnce, aMinMoveAtOnce, false
                                                            );
                    } else if (tTileEntity2.adjacentChestZPos != null) {
                        tMovedItemCount = moveFromSlotToSide(
                                fromTile, tTileEntity2.adjacentChestZPos, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize,
                                aMaxMoveAtOnce, aMinMoveAtOnce, false
                                                            );
                    }
                    if (tMovedItemCount > 0) {
        ...
        return moveStackIntoPipe(
                fromTile, toTile, new int[]{aGrabFrom}, (byte) 6, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize, aMaxMoveAtOnce,
                aMinMoveAtOnce, aDoCheckChests
                                );
    }
    ...
    public static byte moveFromSlotToSide(
        ...
        return moveFromSlotToSide(
                fromTile, toTile, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize, aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, true);
    }
        ...
        if (aStack1 != null && aStack2 != null && aStack1.getItem() == aStack2.getItem()) {
            ...
            return ((aStack1.getTagCompound() == null) == (aStack2.getTagCompound() == null)) &&
                   (aStack1.getTagCompound() == null || aStack1.getTagCompound().equals(aStack2.getTagCompound())) && (
                           Items.feather.getDamage(aStack1) == Items.feather.getDamage(aStack2) || Items.feather.getDamage(aStack1) == W ||
    ...
    public static boolean areFluidsEqual(FluidStack aFluid1, FluidStack aFluid2, boolean aIgnoreNBT) {
        return aFluid1 != null && aFluid2 != null && aFluid1.getFluid() == aFluid2.getFluid() &&
               (aIgnoreNBT || ((aFluid1.tag == null) == (aFluid2.tag == null)) && (aFluid1.tag == null || aFluid1.tag.equals(aFluid2.tag)));
    }
    ...
    public static boolean areStacksEqual(ItemStack aStack1, ItemStack aStack2, boolean aIgnoreNBT) {
        return aStack1 != null && aStack2 != null && aStack1.getItem() == aStack2.getItem() && (
                aIgnoreNBT || (
                       ...
                       Items.feather.getDamage(aStack1) == Items.feather.getDamage(aStack2) || Items.feather.getDamage(aStack1) == W || Items.feather.getDamage(
                               aStack2) == W
               );
    }
    ...
    public static ItemStack fillFluidContainer(FluidStack aFluid, ItemStack aStack, boolean aRemoveFluidDirectly, boolean aCheckIFluidContainerItems) {
        ...
        if (aCheckIFluidContainerItems && aStack.getItem() instanceof IFluidContainerItem && ((IFluidContainerItem) aStack.getItem()).getFluid(aStack) ==
                                                                                             null && ((IFluidContainerItem) aStack.getItem()).getCapacity(
    ...
    public static FluidStack getFluidFromDisplayStack(ItemStack aDisplayStack) {
        if (!isStackValid(aDisplayStack) || aDisplayStack.getItem() != ItemList.Display_Fluid.getItem() || !aDisplayStack.hasTagCompound()) {
            return null;
        }
    ...
    public static ItemStack getContainerItem(ItemStack aStack, boolean aCheckIFluidContainerItems) {
        ...
        if (aStack.getItem() == Items.potionitem || aStack.getItem() == Items.experience_bottle || ItemList.TF_Vial_FieryBlood.isStackEqual(aStack) ||
    ...
    /* public static boolean addSimpleIC2MachineRecipe(ItemStack aInput, Map<IRecipeInput, RecipeOutput> aRecipeList, NBTTagCompound aNBT, Object... aOutput) {
        ...
        if (tStack == null || (tStack.length > 0 && areStacksEqual(aInput, tStack[0]))) {
            return false;
        }
        if (tOreName != null) {
    ...
    public static ItemStack getWrittenBook(String aMapping, String aTitle, String aAuthor, String... aPages) {
        ...
        tNBTList.appendTag(
                new NBTTagString("Credits to " + aAuthor + " for writing this Book. This was Book Nr. " + sBookCount + " at its creation. Gotta get 'em all!"));
        tNBT.setTag("pages", tNBTList);
        rStack.setTagCompound(tNBT);
    ...
    public static boolean doSoundAtClient(
        ...
        if (isStringInvalid(aSoundName) || !FMLCommonHandler.instance().getEffectiveSide().isClient() || GT.getThePlayer() == null ||
            !GT.getThePlayer().worldObj.isRemote) {
            return false;
        }
        if (GregTech_API.sMultiThreadedSounds) {
            new Thread(new GT_Runnable_Sound(GT.getThePlayer().worldObj, MathHelper.floor_double(aX), MathHelper.floor_double(aY), MathHelper.floor_double(aZ),
                                             aTimeUntilNextSound, aSoundName, aSoundStrength, aSoundModulation
            ), "Sound Effect").start();
        } else {
            new GT_Runnable_Sound(GT.getThePlayer().worldObj, MathHelper.floor_double(aX), MathHelper.floor_double(aY), MathHelper.floor_double(aZ),
                                  aTimeUntilNextSound, aSoundName, aSoundStrength, aSoundModulation
            ).run();
        }
        return true;
    ...
    public static ItemStack getProjectile(SubTag aProjectileType, IInventory aInventory) {
        if (aInventory != null) {
            for (int i = 0, j = aInventory.getSizeInventory(); i < j; i++) {
                ...
                if (isStackValid(rStack) && rStack.getItem() instanceof IProjectileItem && ((IProjectileItem) rStack.getItem()).hasProjectile(
                        aProjectileType, rStack)) {
    ...
    public static int getTextureId(Block blockFromBlock, byte metaFromBlock) {
        ...
        throw new RuntimeException(
                "Probably missing mapping or different texture class used for: " + blockFromBlock.getUnlocalizedName() + " meta:" + metaFromBlock);
    }
    ...
    public static float getHeatDamageFromItem(ItemStack aStack) {
        ...
        return tData == null ? 0 : (tData.mPrefix == null ? 0 : tData.mPrefix.mHeatDamage) +
    ...
    public static boolean applyRadioactivity(EntityLivingBase aEntity, int aLevel, int aAmountOfItems) {
        if (aLevel > 0 && aEntity != null && aEntity.getCreatureAttribute() != EnumCreatureAttribute.UNDEAD &&
            aEntity.getCreatureAttribute() != EnumCreatureAttribute.ARTHROPOD && !isWearingFullRadioHazmat(aEntity)) {
            PotionEffect tEffect = null;
            aEntity.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, aLevel * 140 * aAmountOfItems + Math.max(0, (
                    (
                            tEffect = aEntity.getActivePotionEffect(Potion.moveSlowdown)
                    ) == null ? 0 : tEffect.getDuration()
            )), Math.max(0, (5 * aLevel) / 7)));
            aEntity.addPotionEffect(new PotionEffect(Potion.digSlowdown.id, aLevel * 150 * aAmountOfItems + Math.max(0, (
                    (
            ...
            aEntity.addPotionEffect(new PotionEffect(24 /* IC2 Radiation */, aLevel * 180 * aAmountOfItems + Math.max(0, (
                    (
    ...
    public static boolean moveEntityToDimensionAtCoords(Entity entity, int aDimension, double aX, double aY, double aZ) {
        ...
        if ((entity instanceof EntityPlayerMP) && interDimensional) {
            ...
            player.playerNetServerHandler.sendPacket(
                    new S07PacketRespawn(player.dimension, player.worldObj.difficultySetting, destinationWorld.getWorldInfo().getTerrainType(),
    ...
    public static int getCoordinateScan(
        ...
        tList.add("----- X: " + EnumChatFormatting.AQUA + formatNumbers(aX) + EnumChatFormatting.RESET + " Y: " + EnumChatFormatting.AQUA + formatNumbers(aY) +
                  EnumChatFormatting.RESET + " Z: " + EnumChatFormatting.AQUA + formatNumbers(aZ) + EnumChatFormatting.RESET + " D: " +
                  EnumChatFormatting.AQUA + aWorld.provider.dimensionId + EnumChatFormatting.RESET + " -----");
        try {
            if (tTileEntity instanceof IInventory) {
                tList.add(trans("162", "Name: ") + EnumChatFormatting.BLUE + ((IInventory) tTileEntity).getInventoryName() + EnumChatFormatting.RESET +
                          trans("163", " MetaData: ") + EnumChatFormatting.AQUA + aWorld.getBlockMetadata(aX, aY, aZ) + EnumChatFormatting.RESET);
            } else {
                tList.add(trans("162", "Name: ") + EnumChatFormatting.BLUE + tBlock.getUnlocalizedName() + EnumChatFormatting.RESET +
                          trans("163", " MetaData: ") + EnumChatFormatting.AQUA + aWorld.getBlockMetadata(aX, aY, aZ) + EnumChatFormatting.RESET);
            }

            tList.add(trans("164", "Hardness: ") + EnumChatFormatting.YELLOW + tBlock.getBlockHardness(aWorld, aX, aY, aZ) + EnumChatFormatting.RESET +
                      trans("165", " Blast Resistance: ") + EnumChatFormatting.YELLOW +
                      tBlock.getExplosionResistance(aPlayer, aWorld, aX, aY, aZ, aPlayer.posX, aPlayer.posY, aPlayer.posZ) + EnumChatFormatting.RESET);
        ...
        if (tTileEntity != null) {
                ...
                if (tTileEntity instanceof IFluidHandler) {
                    ...
                    if (tTanks != null) {
                        for (byte i = 0; i < tTanks.length; i++) {
                            tList.add(trans("167", "Tank ") + i + ": " + EnumChatFormatting.GREEN +
                                      formatNumbers((tTanks[i].fluid == null ? 0 : tTanks[i].fluid.amount)) + EnumChatFormatting.RESET + " L / " +
                                      EnumChatFormatting.YELLOW + formatNumbers(tTanks[i].capacity) + EnumChatFormatting.RESET + " L " +
                                      EnumChatFormatting.GOLD + getFluidName(tTanks[i].fluid, true) + EnumChatFormatting.RESET);
                        }
                    }
                }
            } catch (Throwable e) {
            ...
            try {
                if (tTileEntity instanceof ic2.api.tile.IWrenchable) {
                    rEUAmount += 100;
                    tList.add(trans("171", "Facing: ") + EnumChatFormatting.GREEN + ((ic2.api.tile.IWrenchable) tTileEntity).getFacing() +
                              EnumChatFormatting.RESET + trans("172", " / Chance: ") + EnumChatFormatting.YELLOW +
                              (((ic2.api.tile.IWrenchable) tTileEntity).getWrenchDropRate() * 100) + EnumChatFormatting.RESET + "%");
                    tList.add(((ic2.api.tile.IWrenchable) tTileEntity).wrenchCanRemove(aPlayer) ? EnumChatFormatting.GREEN +
            ...
            try {
                if (tTileEntity instanceof ic2.api.energy.tile.IEnergyConductor) {
                    rEUAmount += 200;
                    tList.add(trans("175", "Conduction Loss: ") + EnumChatFormatting.YELLOW +
                              ((ic2.api.energy.tile.IEnergyConductor) tTileEntity).getConductionLoss() + EnumChatFormatting.RESET);
                }
            } catch (Throwable e) {
                if (D1) {
                    e.printStackTrace(GT_Log.err);
            ...
            try {
                if (tTileEntity instanceof ic2.api.tile.IEnergyStorage) {
                    rEUAmount += 200;
                    tList.add(trans("176", "Contained Energy: ") + EnumChatFormatting.YELLOW +
                              formatNumbers(((ic2.api.tile.IEnergyStorage) tTileEntity).getStored()) + EnumChatFormatting.RESET + " EU / " +
                              EnumChatFormatting.YELLOW + formatNumbers(((ic2.api.tile.IEnergyStorage) tTileEntity).getCapacity()) + EnumChatFormatting.RESET +
                              " EU");
                    //aList.add(((ic2.api.tile.IEnergyStorage)tTileEntity).isTeleporterCompatible(ic2.api.Direction.YP)?"Teleporter Compatible":"Not
            ...
            try {
                if (tTileEntity instanceof IMachineProgress) {
                    ...
                    if (0 < (tValue = ((IMachineProgress) tTileEntity).getMaxProgress())) {
                        tList.add(trans("178", "Progress/Load: ") + EnumChatFormatting.GREEN + formatNumbers(((IMachineProgress) tTileEntity).getProgress()) +
                                  EnumChatFormatting.RESET + " / " + EnumChatFormatting.YELLOW + formatNumbers(tValue) + EnumChatFormatting.RESET);
                    }
                }
            } catch (Throwable e) {
                if (D1) {
            ...
            try {
                if (tTileEntity instanceof ICoverable) {
                    rEUAmount += 300;
                    String tString = ((ICoverable) tTileEntity).getCoverBehaviorAtSideNew((byte) aSide).getDescription(
                            (byte) aSide, ((ICoverable) tTileEntity).getCoverIDAtSide((byte) aSide), ((ICoverable) tTileEntity).getComplexCoverDataAtSide(
                                    (byte) aSide), (ICoverable) tTileEntity);
            ...
            try {
                if (tTileEntity instanceof IBasicEnergyContainer && ((IBasicEnergyContainer) tTileEntity).getEUCapacity() > 0) {
                    tList.add(
                            trans("179", "Max IN: ") + EnumChatFormatting.RED + formatNumbers(((IBasicEnergyContainer) tTileEntity).getInputVoltage()) + " (" +
                            GT_Values.VN[getTier(((IBasicEnergyContainer) tTileEntity).getInputVoltage())] + ") " + EnumChatFormatting.RESET +
                            trans("182", " EU at ") + EnumChatFormatting.RED + formatNumbers(((IBasicEnergyContainer) tTileEntity).getInputAmperage()) +
                            EnumChatFormatting.RESET + trans("183", " A"));
                    tList.add(trans("181", "Max OUT: ") + EnumChatFormatting.RED + formatNumbers(((IBasicEnergyContainer) tTileEntity).getOutputVoltage()) +
                              " (" + GT_Values.VN[getTier(((IBasicEnergyContainer) tTileEntity).getOutputVoltage())] + ") " + EnumChatFormatting.RESET +
                              trans("182", " EU at ") + EnumChatFormatting.RED + formatNumbers(((IBasicEnergyContainer) tTileEntity).getOutputAmperage()) +
                              EnumChatFormatting.RESET + trans("183", " A"));
                    tList.add(trans("184", "Energy: ") + EnumChatFormatting.GREEN + formatNumbers(((IBasicEnergyContainer) tTileEntity).getStoredEU()) +
                              EnumChatFormatting.RESET + " EU / " + EnumChatFormatting.YELLOW +
                              formatNumbers(((IBasicEnergyContainer) tTileEntity).getEUCapacity()) + EnumChatFormatting.RESET + " EU");
                }
            } catch (Throwable e) {
                if (D1) {
                    e.printStackTrace(GT_Log.err);
            ...
            try {
                if (tTileEntity instanceof IGregTechTileEntity) {
                    tList.add(trans("186", "Owned by: ") + EnumChatFormatting.BLUE + ((IGregTechTileEntity) tTileEntity).getOwnerName() +
                              EnumChatFormatting.RESET);
                }
            } catch (Throwable e) {
                if (D1) {
            ...
            try {
                /* if (tTileEntity instanceof ic2.api.crops.ICropTile) {
                    ...
                    if (crop.getCrop() != null) {
                        tList.add(trans("187", "Type -- Crop-Name: ") + crop.getCrop().name() + trans("188", "  Growth: ") + crop.getGrowth() +
                                  trans("189", "  Gain: ") + crop.getGain() + trans("190", "  Resistance: ") + crop.getResistance());
                    }
                    tList.add(trans("191", "Plant -- Fertilizer: ") + crop.getNutrientStorage() + trans("192", "  Water: ") + crop.getHydrationStorage() +
                              trans("193", "  Weed-Ex: ") + crop.getWeedExStorage() + trans("194", "  Scan-Level: ") + crop.getScanLevel());
                    tList.add(trans("195", "Environment -- Nutrients: ") + crop.getNutrients() + trans("196", "  Humidity: ") + crop.getHumidity() +
        ...
        if (aPlayer.capabilities.isCreativeMode) {
            ...
            if (tFluid != null) {
                tList.add(EnumChatFormatting.GOLD + tFluid.getLocalizedName() + EnumChatFormatting.RESET + ": " + EnumChatFormatting.YELLOW +
                          formatNumbers(tFluid.amount) + EnumChatFormatting.RESET + " L");
            } else {
                tList.add(EnumChatFormatting.GOLD + trans("201", "Nothing") + EnumChatFormatting.RESET + ": " + EnumChatFormatting.YELLOW + '0' +
                          EnumChatFormatting.RESET + " L");
            }
        }
//      if(aPlayer.capabilities.isCreativeMode){
        if (GT_Pollution.hasPollution(currentChunk)) {
            tList.add(trans("202", "Pollution in Chunk: ") + EnumChatFormatting.RED + formatNumbers(GT_Pollution.getPollution(currentChunk)) +
                      EnumChatFormatting.RESET + trans("203", " gibbl"));
        } else {
        ...
        BlockScanningEvent tEvent = new BlockScanningEvent(
                aWorld, aPlayer, aX, aY, aZ, (byte) aSide, aScanLevel, tBlock, tTileEntity, tList, aClickX, aClickY, aClickZ);
    ...
    /**
     * @return an Array containing the X and the Y Coordinate of the clicked Point, with the top left Corner as Origin, like on the Texture Sheet. return
* values should always be between [0.0F and 0.99F].
    ...
    public static boolean consumeItems(EntityPlayer player, ItemStack stack, gregtech.api.enums.Materials mat, int count) {
        if (stack != null && GT_OreDictUnificator.getItemData(stack).mMaterial.mMaterial == mat && stack.stackSize >= count) {
            if ((!player.capabilities.isCreativeMode) && (stack.stackSize != 111)) {
                stack.stackSize -= count;
            }
            return true;
...
//        System.out.println("Registering Reverse Recipe for: " + GT_LanguageManager.getTranslation(GT_LanguageManager.getTranslateableItemStackName(output)
...
//                System.out.println("Found OreDictEntry: "+o.getKey());
                ...
                if (ToolDictNames.contains(dictName)) {
                    continue;
                }
...
//                        System.out.println("OreDict Entry "+o.getKey()+" couldn't be found!");
    ...
    public static boolean isBlockReplaceableForOreGeneration(
            World world, int x, int y, int z, Block toReplace, Block... blocks
                                                            ) {
                    ...
                    if (tGrabStack.stackSize >= aMinMoveAtOnce && isAllowedToTakeFromSlot(aTileEntity1, tGrabSlot, aGrabFrom, tGrabStack)) {
                        for (int tPutSlot : tPutSlots) {
                            if (isAllowedToPutIntoSlot((IInventory) aTileEntity2, tPutSlot, aPutTo, tGrabStack, aMaxTargetStackSize)) {
                                tMovedItemCount += moveStackFromSlotAToSlotB(
                                        aTileEntity1, (IInventory) aTileEntity2, tGrabSlot, tPutSlot, aMaxTargetStackSize, aMinTargetStackSize,
                                        (byte) (aMaxMoveAtOnce - tMovedItemCount), aMinMoveAtOnce
                                                                            );
                ...
                if (tTileEntity1.adjacentChestChecked) {
                    ...
                    if (tTileEntity1.adjacentChestXNeg != null) {
                        tAmount = moveOneItemStack(
                                tTileEntity1.adjacentChestXNeg, aTileEntity2, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize,
                                aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, false
                                                  );
                    } else if (tTileEntity1.adjacentChestZNeg != null) {
                        tAmount = moveOneItemStack(
                                tTileEntity1.adjacentChestZNeg, aTileEntity2, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize,
                                aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, false
                                                  );
                    } else if (tTileEntity1.adjacentChestXPos != null) {
                        tAmount = moveOneItemStack(
                                tTileEntity1.adjacentChestXPos, aTileEntity2, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize,
                                aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, false
                                                  );
                    } else if (tTileEntity1.adjacentChestZPos != null) {
                        tAmount = moveOneItemStack(
                                tTileEntity1.adjacentChestZPos, aTileEntity2, aGrabFrom, aPutTo, aFilter, aInvertFilter, aMaxTargetStackSize,
                                aMinTargetStackSize, aMaxMoveAtOnce, aMinMoveAtOnce, false
                                                  );
                    }
                    if (tAmount != 0) {
