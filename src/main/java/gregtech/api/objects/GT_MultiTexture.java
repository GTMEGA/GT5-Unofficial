...
public class GT_MultiTexture implements ITexture {
    ...
    public void renderXPos(RenderBlocks aRenderer, Block aBlock, int aX, int aY, int aZ) {
        for (ITexture tTexture : mTextures) {
            if (tTexture != null && tTexture.isValidTexture()) {
                tTexture.renderXPos(aRenderer, aBlock, aX, aY, aZ);
            }
        }
    }
    ...
    public void renderXNeg(RenderBlocks aRenderer, Block aBlock, int aX, int aY, int aZ) {
        for (ITexture tTexture : mTextures) {
            if (tTexture != null && tTexture.isValidTexture()) {
                tTexture.renderXNeg(aRenderer, aBlock, aX, aY, aZ);
            }
        }
    }
    ...
    public void renderYPos(RenderBlocks aRenderer, Block aBlock, int aX, int aY, int aZ) {
        for (ITexture tTexture : mTextures) {
            if (tTexture != null && tTexture.isValidTexture()) {
                tTexture.renderYPos(aRenderer, aBlock, aX, aY, aZ);
            }
        }
    }
    ...
    public void renderYNeg(RenderBlocks aRenderer, Block aBlock, int aX, int aY, int aZ) {
        for (ITexture tTexture : mTextures) {
            if (tTexture != null && tTexture.isValidTexture()) {
                tTexture.renderYNeg(aRenderer, aBlock, aX, aY, aZ);
            }
        }
    }
    ...
    public void renderZPos(RenderBlocks aRenderer, Block aBlock, int aX, int aY, int aZ) {
        for (ITexture tTexture : mTextures) {
            if (tTexture != null && tTexture.isValidTexture()) {
                tTexture.renderZPos(aRenderer, aBlock, aX, aY, aZ);
            }
        }
    }
    ...
    public void renderZNeg(RenderBlocks aRenderer, Block aBlock, int aX, int aY, int aZ) {
        for (ITexture tTexture : mTextures) {
            if (tTexture != null && tTexture.isValidTexture()) {
                tTexture.renderZNeg(aRenderer, aBlock, aX, aY, aZ);
            }
        }
    }
