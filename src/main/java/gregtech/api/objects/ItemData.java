...
public class ItemData {
    ...
    public ItemData(OrePrefixes aPrefix, Materials aMaterial, boolean aBlackListed) {
        ...
        mByProducts = aPrefix.mSecondaryMaterial == null || aPrefix.mSecondaryMaterial.mMaterial == null ? EMPTY_MATERIALSTACK_ARRAY : new MaterialStack[]{
    ...
    public String toString() {
        if (mPrefix == null || mMaterial == null || mMaterial.mMaterial == null) {
            return "";
        }
