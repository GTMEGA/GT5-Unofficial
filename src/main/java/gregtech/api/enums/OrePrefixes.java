...
public enum OrePrefixes {
    ...
    pipeMedium("Medium Pipes", "Medium ", " Pipe", true, true, false, false, true, false, true, false, false, false, 0, M * 2, 64, 80),
    pipeLarge("Large pipes", "Large ", " Pipe", true, true, false, false, true, false, true, false, false, false, 0, M * 8, 64, 81),
    ...
    circuitLogic("LOGICCircuits", "", "", true, true, false, false, false, false, false, false, false, false, 0, -1, 64, -1), // Introduced by HTX. "sledgehammer approach"
    circuitPower("PWRCircuits", "", "", true, true, false, false, false, false, false, false, false, false, 0, -1, 64, -1), // Introduced by HTX. "scalpel approach"
    ...
    static {
        ...
        toolHeadFile.mCondition = new ICondition.Not<ISubTagContainer>(SubTag.BOUNCY);
        toolHeadSaw.mCondition = new ICondition.Not<ISubTagContainer>(SubTag.BOUNCY);
        toolHeadDrill.mCondition = new ICondition.Not<ISubTagContainer>(SubTag.BOUNCY);
        toolHeadChainsaw.mCondition = new ICondition.Not<ISubTagContainer>(SubTag.BOUNCY);
        toolHeadWrench.mCondition = new ICondition.Not<ISubTagContainer>(SubTag.BOUNCY);
        toolHeadBuzzSaw.mCondition = new ICondition.Not<ISubTagContainer>(SubTag.BOUNCY);
        turbineBlade.mCondition = new ICondition.Not<ISubTagContainer>(SubTag.BOUNCY);
        ...
        for (Materials aMaterial : Materials.values()) {
            if (aMaterial.mMetaItemSubID > 0) {
                ...
                if (!enableUnusedPlates && ((aMaterial.mTypes & 0x40) == 0) && !(aMaterial == Materials.Silicon || aMaterial == Materials.Zinc ||
                        ...
                        aMaterial == Materials.Paper || aMaterial == Materials.Jasper ||
