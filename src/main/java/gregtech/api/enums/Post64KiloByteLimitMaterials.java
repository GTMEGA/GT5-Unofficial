...
public class Post64KiloByteLimitMaterials implements IMaterialHandler {

    public Post64KiloByteLimitMaterials() {
        GT_FML_LOGGER.info("Registering Extra Materials");
        Materials.add(this);
    }
