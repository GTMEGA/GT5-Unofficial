...
public class Textures {
    public enum BlockIcons implements IIconContainer, Runnable {
        ...
        MINING_EXPLOSIVE, DAISY_CUTTER, TUNEX, FLAT_BOMB,
        ...
        // Item/Fluid IO icons for if there is no IO for one reason or another
        OVERLAY_IN_DISABLED, OVERLAY_OUT_DISABLED;
