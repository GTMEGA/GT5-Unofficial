...
public class Textures {
    public enum BlockIcons implements IIconContainer, Runnable {
        ...
        public static ITexture[] OVERLAYS_ENERGY_IN = {
                TextureFactory.of(OVERLAY_ENERGY_IN_TM_ULV, new short[]{180, 180, 180, 0}),
                TextureFactory.of(OVERLAY_ENERGY_IN_TM_LV, new short[]{220, 220, 220, 0}),
                TextureFactory.of(OVERLAY_ENERGY_IN_TM_MV, new short[]{255, 100, 0, 0}),
                TextureFactory.of(OVERLAY_ENERGY_IN_TM_HV, new short[]{255, 255, 30, 0}),
                TextureFactory.of(OVERLAY_ENERGY_IN_TM_EV, new short[]{128, 128, 128, 0}),
                TextureFactory.of(OVERLAY_ENERGY_IN_TM_IV, new short[]{240, 240, 245, 0}),
                TextureFactory.of(OVERLAY_ENERGY_IN_TM_LuV, new short[]{220, 220, 245, 0}),
                TextureFactory.of(OVERLAY_ENERGY_IN_TM_ZPM, new short[]{200, 200, 245, 0}),
                TextureFactory.of(OVERLAY_ENERGY_IN_TM_UV, new short[]{180, 180, 245, 0}),
                TextureFactory.of(OVERLAY_ENERGY_IN_TM_UHV, new short[]{160, 160, 245, 0}),
                TextureFactory.of(OVERLAY_ENERGY_IN_TM_UEV, new short[]{140, 140, 245, 0}),
                TextureFactory.of(OVERLAY_ENERGY_IN_TM_UIV, new short[]{120, 120, 245, 0}),
                TextureFactory.of(OVERLAY_ENERGY_IN_TM_UMV, new short[]{100, 100, 245, 0}),
                TextureFactory.of(OVERLAY_ENERGY_IN_TM_UXV, new short[]{80, 80, 245, 0}),
                TextureFactory.of(OVERLAY_ENERGY_IN_TM_OpV, new short[]{60, 60, 245, 0}),
                TextureFactory.of(OVERLAY_ENERGY_IN_TM_MAX, new short[]{40, 40, 245, 0}),
        };
