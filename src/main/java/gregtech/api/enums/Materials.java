...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials Cryolite                = new Materials(436, TextureSet.SET_DULL,1.0F,0,1,1|8|32       ,10,255,200,0,"Cryolite","Cryolite",0,0,1000,1000,true,false,3,1,1,Dyes._NULL).disableAutoGeneratedBlastFurnaceRecipes();
    ...
    public static Materials Cassiterite             = new Materials( 824, TextureSet.SET_METALLIC          ,   1.0F,      0,  3,       8                   , 58, 28, 35,   64,   "Cassiterite"             ,   "Cassiterite"                   ,    0,       0,         -1,    0, false, false,   4,   3,   1, Dyes.dyeWhite       , 1, Arrays.asList(new MaterialStack(Tin, 1), new MaterialStack(Oxygen, 2)));
...
//      Midasium                .setEnchantmentForTools(Enchantment.fortune, 2);
    ...
    private static void setByProducts() {
        Cryolite.addOreByProduct(Bauxite);
