...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials IC2_Biogas              = new MaterialBuilder(212, TextureSet.SET_FLUID, "Biogas").setName("ic2Biogas").addCell().addGas().setRGB(167, 152,  76).setColor(Dyes.dyeYellow).constructMaterial();
    ...
    public static Materials Steam                   = new MaterialBuilder(899, TextureSet.SET_FLUID, "Steam").addCell().addGas().setName("Steam").setRGB(188, 188, 188).setColor(Dyes.dyeGray).constructMaterial();
    public static Materials SuperheatedSteam        = new MaterialBuilder(900, TextureSet.SET_FLUID, "Superheated Steam").addCell().addGas().setName("SuperheatedSteam").setRGB(202, 209, 209).setColor(Dyes.dyeGray).constructMaterial();
