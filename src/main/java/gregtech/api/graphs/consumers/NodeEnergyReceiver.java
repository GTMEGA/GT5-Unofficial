...
public class NodeEnergyReceiver extends ConsumerNode {
    ...
    public int injectEnergy(long aVoltage, long aMaxAmps) {
        ...
        if (GregTech_API.mRFExplosions && GregTech_API.sMachineExplosions && ((IEnergyReceiver) mTileEntity).getMaxEnergyStored(tDirection) < rfOut * 600L) {
            explode(rfOut);
        }
        return 0;
    }
