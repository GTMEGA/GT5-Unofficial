...
public class GT_MetaTileEntity_Hatch_OutputBus extends GT_MetaTileEntity_Hatch {
    ...
    public ITexture[] getTexturesActive(ITexture aBaseTexture) {
        return new ITexture[]{aBaseTexture, TextureFactory.of(OVERLAY_ITEM_OUT)};
    }
    ...
    public Object getClientGUI(int aID, InventoryPlayer aPlayerInventory, IGregTechTileEntity aBaseMetaTileEntity) {
        switch (mTier) {
            case 0:
                return new GT_GUIContainer_1by1(aPlayerInventory, aBaseMetaTileEntity, "Item Output Hatch");
            case 1:
                return new GT_GUIContainer_2by2(aPlayerInventory, aBaseMetaTileEntity, "Item Output Hatch");
            case 2:
                return new GT_GUIContainer_3by3(aPlayerInventory, aBaseMetaTileEntity, "Item Output Hatch");
            default:
                return new GT_GUIContainer_4by4(aPlayerInventory, aBaseMetaTileEntity, "Item Output Hatch");
        }
    }
