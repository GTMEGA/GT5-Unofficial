                        ...
                        if (((IFoodStat) tRandomData).getFoodAction(this, rStack) == EnumAction.eat) {
                            ...
                            if (tFoodValue > 0) {
                                RA.addCannerRecipe(rStack, ItemList.IC2_Food_Can_Empty.get(tFoodValue),
                                                   ((IFoodStat) tRandomData).isRotten(this, rStack, null) ? ItemList.IC2_Food_Can_Spoiled.get(tFoodValue)
                                                                                                          : ItemList.IC2_Food_Can_Filled.get(tFoodValue), null,
                                                   tFoodValue * 100, 1
                                                  );
                            }
                        }
        ...
        if (tStat != null) {
            if (Loader.isModLoaded(MOD_ID_APC)) {
                aPlayer.getFoodStats().func_151686_a(
                        (ItemFood) GT_Utility.callConstructor("squeek.applecore.api.food.ItemFoodProxy.ItemFoodProxy", 0, null, true, this), aStack);
            } else {
